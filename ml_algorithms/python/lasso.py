"""Lasso regression (L1-regularized linear regression) in NumPy."""
...
class LassoRegression:
    ...
    def fit(self, x: np.ndarray, y: np.ndarray) -> LassoRegression:
        ...
        # Track current prediction to update efficiently.
        y_pred = xs @ w
        ...
        for _ in range(max_iter):
            ...
            for j in range(n_features):
                ...
                w_j = _soft_threshold(rho, alpha) / float(col_norm[j] + 1e-12)
