...
def test_toy_diffusion_style_transfer_data_and_model_contract() -> None:
    from tracks.generative.lesson_22_toy_diffusion_style_transfer.data import DataConfig, get_dataloaders
    from tracks.generative.lesson_22_toy_diffusion_style_transfer.model import (
        DiffusionSchedule,
        ModelConfig,
    ...
    model = ToyStyleTransferDiffusionModel(cfg)
...
def test_toy_diffusion_style_transfer_training_and_dry_run(
    tmp_path, monkeypatch: pytest.MonkeyPatch
) -> None:
    from tracks.generative.lesson_22_toy_diffusion_style_transfer.data import DataConfig
    from tracks.generative.lesson_22_toy_diffusion_style_transfer.model import DiffusionSchedule, ModelConfig
    from tracks.generative.lesson_22_toy_diffusion_style_transfer.train import TrainConfig, run_training
    ...
    assert exit_code == 0
    run_dir = tmp_path / "generative" / "lesson_22_toy_diffusion_style_transfer" / "pytest_style_transfer_smoke"
    ...
    proc = subprocess.run(
        [
            ...
            "generative",
            "lesson_22_toy_diffusion_style_transfer",
            "--dry-run",
        ],
        check=False,
        capture_output=True,
    ...
    assert "tracks.generative.lesson_22_toy_diffusion_style_transfer.train" in proc.stdout
