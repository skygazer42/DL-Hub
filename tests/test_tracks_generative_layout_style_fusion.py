...
def test_compact_diffusion_layout_style_fusion_data_and_model_contract() -> None:
    from tracks.generative.lesson_40_compact_diffusion_layout_style_fusion.data import (
        DataConfig,
        get_dataloaders,
    )
    from tracks.generative.lesson_40_compact_diffusion_layout_style_fusion.model import (
        DiffusionSchedule,
        ModelConfig,
        CompactLayoutStyleFusionDiffusionModel,
        q_sample,
    )
    ...
    model = CompactLayoutStyleFusionDiffusionModel(cfg)
...
def test_compact_diffusion_layout_style_fusion_training_smoke(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    from tracks.generative.lesson_40_compact_diffusion_layout_style_fusion.data import DataConfig
    from tracks.generative.lesson_40_compact_diffusion_layout_style_fusion.model import (
        DiffusionSchedule,
        ModelConfig,
    )
    from tracks.generative.lesson_40_compact_diffusion_layout_style_fusion.train import (
        TrainConfig,
        run_training,
    )
