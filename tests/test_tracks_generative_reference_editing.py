...
def test_toy_diffusion_reference_editing_data_and_model_contract() -> None:
    from tracks.generative.lesson_31_toy_diffusion_reference_editing.data import DataConfig, get_dataloaders
    from tracks.generative.lesson_31_toy_diffusion_reference_editing.model import (
        DiffusionSchedule,
        ModelConfig,
    ...
    model = ToyReferenceEditingDiffusionModel(cfg)
...
def test_toy_diffusion_reference_editing_training_smoke(tmp_path, monkeypatch: pytest.MonkeyPatch) -> None:
    from tracks.generative.lesson_31_toy_diffusion_reference_editing.data import DataConfig
    from tracks.generative.lesson_31_toy_diffusion_reference_editing.model import DiffusionSchedule, ModelConfig
    from tracks.generative.lesson_31_toy_diffusion_reference_editing.train import TrainConfig, run_training
    ...
    assert exit_code == 0
    run_dir = tmp_path / "generative" / "lesson_31_toy_diffusion_reference_editing" / "pytest_reference_editing_smoke"
