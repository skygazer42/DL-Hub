...
def test_dlhub_vision_detection_models_forward_backward_smoke() -> None:
    ...
    center = build_centernet_detector(
    ...
    retina = build_retinanet_detector(
        in_channels=3, num_classes=3, variant="retinanet_tiny", width_mult=0.5
    )
    out = retina(x)
...
def test_dlhub_vision_segmentation_models_forward_backward_smoke() -> None:
    from dlhub.vision.segmentation import (
