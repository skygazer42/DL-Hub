...
def test_toy_diffusion_layout_reference_fusion_data_and_model_contract() -> None:
    from tracks.generative.lesson_34_toy_diffusion_layout_reference_fusion.data import (
        DataConfig,
        get_dataloaders,
    )
    from tracks.generative.lesson_34_toy_diffusion_layout_reference_fusion.model import (
        DiffusionSchedule,
        ModelConfig,
    ...
    model = ToyLayoutReferenceFusionDiffusionModel(cfg)
...
def test_toy_diffusion_layout_reference_fusion_training_smoke(
    tmp_path, monkeypatch: pytest.MonkeyPatch
) -> None:
    from tracks.generative.lesson_34_toy_diffusion_layout_reference_fusion.data import DataConfig
    from tracks.generative.lesson_34_toy_diffusion_layout_reference_fusion.model import (
        DiffusionSchedule,
        ModelConfig,
    )
    from tracks.generative.lesson_34_toy_diffusion_layout_reference_fusion.train import (
        TrainConfig,
        run_training,
    )
