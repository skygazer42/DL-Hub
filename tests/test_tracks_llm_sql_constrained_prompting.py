...
def test_llm_sql_constrained_prompting_batch_mask_and_loss_smoke() -> None:
    from tracks.llm.lesson_37_compact_sql_constrained_prompting.data import DataConfig, get_dataloaders
    from tracks.llm.lesson_37_compact_sql_constrained_prompting.model import (
        ModelConfig,
...
def test_llm_sql_constrained_prompting_training_smoke(tmp_path) -> None:
    from tracks.llm.lesson_37_compact_sql_constrained_prompting.data import DataConfig
    from tracks.llm.lesson_37_compact_sql_constrained_prompting.train import TrainConfig, run_training
