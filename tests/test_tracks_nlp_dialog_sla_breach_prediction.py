...
def test_dialog_sla_breach_prediction_batch_contract() -> None:
    from tracks.nlp.lesson_44_compact_dialog_sla_breach_prediction.data import DataConfig, get_dataloaders
    from tracks.nlp.lesson_44_compact_dialog_sla_breach_prediction.model import (
...
def test_dialog_sla_breach_prediction_training_smoke(tmp_path) -> None:
    from tracks.nlp.lesson_44_compact_dialog_sla_breach_prediction.data import DataConfig
    from tracks.nlp.lesson_44_compact_dialog_sla_breach_prediction.train import TrainConfig, run_training
