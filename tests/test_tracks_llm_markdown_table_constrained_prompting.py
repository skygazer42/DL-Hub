...
def test_llm_markdown_table_constrained_prompting_batch_mask_and_loss_smoke() -> None:
    ...
    table_positions = (inputs["input_ids"] == int(vocab.markdown_table_token_id)).to(torch.int64).argmax(dim=1)
    ...
    try:
        exit_code = run_training(
            TrainConfig(
                ...
                max_train_batches=2,
                max_eval_batches=1,
                run_name="pytest_markdown_table_constrained_prompting_smoke",
