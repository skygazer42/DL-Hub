...
def test_dialog_callback_prediction_batch_contract() -> None:
    from tracks.nlp.lesson_43_compact_dialog_callback_prediction.data import DataConfig, get_dataloaders
    from tracks.nlp.lesson_43_compact_dialog_callback_prediction.model import (
    ...
    assert "callback" in vocab.token_to_id
    assert "followup" in vocab.token_to_id
    assert "customer" in vocab.token_to_id
...
def test_dialog_callback_prediction_training_smoke(tmp_path) -> None:
    from tracks.nlp.lesson_43_compact_dialog_callback_prediction.data import DataConfig
    from tracks.nlp.lesson_43_compact_dialog_callback_prediction.train import TrainConfig, run_training
    ...
    try:
        exit_code = run_training(
            TrainConfig(
                ...
                max_train_batches=2,
                max_eval_batches=1,
                run_name="pytest_dialog_callback_prediction_smoke",
                embed_dim=32,
                dropout=0.0,
            ),
            DataConfig(
    ...
    run_dir = (
        ...
        / "pytest_dialog_callback_prediction_smoke"
    )
