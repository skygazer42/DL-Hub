...
def test_dialog_callback_prediction_batch_contract() -> None:
    from tracks.nlp.lesson_43_toy_dialog_callback_prediction.data import DataConfig, get_dataloaders
    from tracks.nlp.lesson_43_toy_dialog_callback_prediction.model import (
...
def test_dialog_callback_prediction_training_smoke(tmp_path) -> None:
    from tracks.nlp.lesson_43_toy_dialog_callback_prediction.data import DataConfig
    from tracks.nlp.lesson_43_toy_dialog_callback_prediction.train import TrainConfig, run_training
