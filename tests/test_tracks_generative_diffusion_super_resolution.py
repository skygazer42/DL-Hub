...
def test_compact_diffusion_super_resolution_data_and_model_contract() -> None:
    from tracks.generative.lesson_15_compact_diffusion_super_resolution.data import DataConfig, get_dataloaders
    from tracks.generative.lesson_15_compact_diffusion_super_resolution.model import (
        DiffusionSchedule,
        ModelConfig,
        CompactSuperResolutionDiffusionModel,
        q_sample,
    )
    ...
    model = CompactSuperResolutionDiffusionModel(cfg)
...
def test_compact_diffusion_super_resolution_training_and_dry_run(
    tmp_path, monkeypatch: pytest.MonkeyPatch
) -> None:
    from tracks.generative.lesson_15_compact_diffusion_super_resolution.data import DataConfig
    from tracks.generative.lesson_15_compact_diffusion_super_resolution.model import (
        DiffusionSchedule,
        ModelConfig,
    )
    from tracks.generative.lesson_15_compact_diffusion_super_resolution.train import TrainConfig, run_training
    ...
    assert exit_code == 0
    run_dir = tmp_path / "generative" / "lesson_15_compact_diffusion_super_resolution" / "pytest_diffusion_super_resolution_smoke"
