...
def test_pedestrian_hog_svm_detector_forward_backward_smoke() -> None:
    ...
    assert "dldet:pedestrian_hog_svm" in list_local_arches()

    model = build_local_model(
        "dldet:pedestrian_hog_svm", in_channels=3, num_classes=1, width_mult=0.5
    )
