...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--in-channels", type=int, default=3, help="Input channels for local stylizers.")
    ...
    parser.add_argument("--steps", type=int, default=6, help="Sampling/optimization steps (method-dependent).")
    parser.add_argument("--strength", type=float, default=0.5, help="Noise strength for diffusion img2img stylizers.")
    parser.add_argument("--style-dim", type=int, default=64, help="Style embedding dimension (method-dependent).")
    parser.add_argument("--control-scale", type=float, default=1.0, help="ControlNet hint scale (method-dependent).")
    parser.add_argument("--num-layers", type=int, default=2, help="Layer count (method-dependent).")
    parser.add_argument("--guidance-scale", type=float, default=2.0, help="CFG scale for diffusion stylizers.")
    parser.add_argument("--ref-weight", type=float, default=1.0, help="Reference attention weight (method-dependent).")
    parser.add_argument("--temperature", type=float, default=1.0, help="Attention temperature (method-dependent).")
