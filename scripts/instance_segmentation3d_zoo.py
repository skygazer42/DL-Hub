...
def main() -> int:
    ...
    from dlhub.pointcloud.instance_segmentation3d_zoo import build_local_model, list_local_arches

    args = parse_args()

    if not args.list and args.smoke is None:
        print("Nothing to do. Try one of:")
        print("- python scripts/instance_segmentation3d_zoo.py --list")
        print("- python scripts/instance_segmentation3d_zoo.py --smoke pcinst3d:mask3d_tiny")
        return 2
    ...
    if args.list:
        print("3D instance segmentation local zoo")
