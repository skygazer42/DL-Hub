...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="3D detection local model zoo utilities (no downloads)."
    )
    ...
    parser.add_argument(
        "--in-channels", type=int, default=3, help="Point channels for local detectors (>=3)."
    )
    ...
    parser.add_argument(
        "--dropout", type=float, default=0.0, help="Dropout rate for local detectors."
    )
