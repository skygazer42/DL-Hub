...
- keep lessons toy-first and CPU-friendly
...
| L05 | `batch410-pointcloud-upsampling-pointcloud` | `.worktrees/batch410-pointcloud-upsampling-pointcloud` | `tracks/pointcloud` | `pointcloud_upsampling_track_lesson` | `tracks/pointcloud/lesson_34_toy_pointcloud_upsampling/`, `tests/test_tracks_pointcloud_upsampling.py` | `README.md`, `tracks/pointcloud/README.md`, `tracks/vision/README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_pointcloud_upsampling.py`<br>`python scripts/run_lesson.py pointcloud lesson_34_toy_pointcloud_upsampling --dry-run` |
| L06 | `batch410-shape-correspondence3d-pointcloud` | `.worktrees/batch410-shape-correspondence3d-pointcloud` | `tracks/pointcloud` | `shape_correspondence_3d_track_lesson` | `tracks/pointcloud/lesson_35_toy_shape_correspondence_3d/`, `tests/test_tracks_pointcloud_shape_correspondence3d.py` | `README.md`, `tracks/pointcloud/README.md`, `tracks/vision/README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_pointcloud_shape_correspondence3d.py`<br>`python scripts/run_lesson.py pointcloud lesson_35_toy_shape_correspondence_3d --dry-run` |
| L07 | `batch410-text-to-3d-generative` | `.worktrees/batch410-text-to-3d-generative` | `tracks/generative` | `text_to_3d_generative_lesson` | `tracks/generative/lesson_47_toy_text_to_3d/`, `tests/test_tracks_generative_text_to_3d.py` | `README.md`, `tracks/pointcloud/README.md`, `tracks/vision/README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_generative_text_to_3d.py`<br>`python scripts/run_lesson.py generative lesson_47_toy_text_to_3d --dry-run` |
| L08 | `batch410-image-to-3d-generative` | `.worktrees/batch410-image-to-3d-generative` | `tracks/generative` | `image_to_3d_generative_lesson` | `tracks/generative/lesson_48_toy_image_to_3d/`, `tests/test_tracks_generative_image_to_3d.py` | `README.md`, `tracks/pointcloud/README.md`, `tracks/vision/README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_generative_image_to_3d.py`<br>`python scripts/run_lesson.py generative lesson_48_toy_image_to_3d --dry-run` |
| L09 | `batch410-text-to-video-generative` | `.worktrees/batch410-text-to-video-generative` | `tracks/generative` | `text_to_video_generative_lesson` | `tracks/generative/lesson_49_toy_text_to_video/`, `tests/test_tracks_generative_text_to_video.py` | `README.md`, `tracks/pointcloud/README.md`, `tracks/vision/README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_generative_text_to_video.py`<br>`python scripts/run_lesson.py generative lesson_49_toy_text_to_video --dry-run` |
| L10 | `batch410-video-to-video-generative` | `.worktrees/batch410-video-to-video-generative` | `tracks/generative` | `video_to_video_generative_lesson` | `tracks/generative/lesson_50_toy_video_to_video/`, `tests/test_tracks_generative_video_to_video.py` | `README.md`, `tracks/pointcloud/README.md`, `tracks/vision/README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_generative_video_to_video.py`<br>`python scripts/run_lesson.py generative lesson_50_toy_video_to_video --dry-run` |
