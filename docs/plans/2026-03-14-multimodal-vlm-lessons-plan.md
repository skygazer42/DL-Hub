...
**Goal:** Add a new `tracks/multimodal` teaching track and implement `lesson_01_clip_compact_retrieval` as an independent educational CLIP-style model with synthetic data, a runnable training script, and focused tests.
...
- `lesson_01_clip_compact_retrieval` to appear in `python scripts/run_lesson.py multimodal --list`
- dry-run resolution to `tracks.multimodal.lesson_01_clip_compact_retrieval.train`
...
- Create: `tracks/multimodal/lesson_01_clip_compact_retrieval/__init__.py`
- Create: `tracks/multimodal/lesson_01_clip_compact_retrieval/data.py`
- Create: `tracks/multimodal/lesson_01_clip_compact_retrieval/README.md`
...
**Files:**
- Create: `tracks/multimodal/lesson_01_clip_compact_retrieval/model.py`
- Test: `tests/test_tracks_multimodal_clip.py`
...
**Files:**
- Create: `tracks/multimodal/lesson_01_clip_compact_retrieval/train.py`
- Test: `tests/test_tracks_multimodal_clip.py`
...
`python -m tracks.multimodal.lesson_01_clip_compact_retrieval.train --epochs 1 --num-samples 64 --batch-size 8 --max-train-batches 2 --max-eval-batches 1 --device cpu --run-name pytest_clip`

Assert that it exits successfully and writes:

- `outputs/multimodal/lesson_01_clip_compact_retrieval/pytest_clip/config.json`
- `outputs/multimodal/lesson_01_clip_compact_retrieval/pytest_clip/metrics.jsonl`
- `outputs/multimodal/lesson_01_clip_compact_retrieval/pytest_clip/checkpoints/checkpoint.pt`
...
- `python scripts/run_lesson.py multimodal lesson_01_clip_compact_retrieval --dry-run`
