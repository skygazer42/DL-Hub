...
| --- | --- | --- | --- | --- | --- | --- | --- |
| L01 | `batch170-chat-sft` | `.worktrees/batch170-chat-sft` | `tracks/llm` | `conversational_llm_lesson` | `tracks/llm/lesson_02_toy_chat_sft/`, `tests/test_tracks_llm_chat_sft.py` | `README.md`, `tracks/llm/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_llm_chat_sft.py`<br>`python scripts/run_lesson.py llm lesson_02_toy_chat_sft --dry-run` |
| L02 | `batch170-mamba-llm` | `.worktrees/batch170-mamba-llm` | `tracks/llm` | `mamba_sequence_lesson` | `tracks/llm/lesson_03_toy_mamba_language_model/`, `tests/test_tracks_llm_mamba.py` | `README.md`, `tracks/llm/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_llm_mamba.py`<br>`python scripts/run_lesson.py llm lesson_03_toy_mamba_language_model --dry-run` |
| L03 | `batch170-diffusion-lesson` | `.worktrees/batch170-diffusion-lesson` | `tracks/generative` | `diffusion_lesson` | `tracks/generative/lesson_03_toy_diffusion_mnist/`, `tests/test_tracks_generative_diffusion.py` | `README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_generative_diffusion.py`<br>`python scripts/run_lesson.py generative lesson_03_toy_diffusion_mnist --dry-run` |
| L04 | `batch170-latent-diffusion-lesson` | `.worktrees/batch170-latent-diffusion-lesson` | `tracks/generative` | `latent_diffusion_lesson` | `tracks/generative/lesson_04_toy_latent_diffusion/`, `tests/test_tracks_generative_latent_diffusion.py` | `README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_generative_latent_diffusion.py`<br>`python scripts/run_lesson.py generative lesson_04_toy_latent_diffusion --dry-run` |
...
| L09 | `batch170-text-matching-lesson` | `.worktrees/batch170-text-matching-lesson` | `tracks/nlp` | `text_matching_lesson` | `tracks/nlp/lesson_08_toy_text_matching_biencoder/`, `tests/test_tracks_nlp_text_matching.py` | `README.md`, `tracks/nlp/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_nlp_text_matching.py`<br>`python scripts/run_lesson.py nlp lesson_08_toy_text_matching_biencoder --dry-run` |
| L10 | `batch170-transformer-summarization-lesson` | `.worktrees/batch170-transformer-summarization-lesson` | `tracks/nlp` | `transformer_summarization_lesson` | `tracks/nlp/lesson_09_toy_transformer_summarization/`, `tests/test_tracks_nlp_transformer_summarization.py` | `README.md`, `tracks/nlp/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_nlp_transformer_summarization.py`<br>`python scripts/run_lesson.py nlp lesson_09_toy_transformer_summarization --dry-run` |
