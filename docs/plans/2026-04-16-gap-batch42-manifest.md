...
- replace `pointcloud/reconstruction` with `vision/anomaly_detection` because `tracks/pointcloud/lesson_07_pointnet_toy_reconstruction/` already covers the reconstruction teaching slot
...
| L09 | `batch420-pointcloud-registration-pointcloud` | `.worktrees/batch420-pointcloud-registration-pointcloud` | `tracks/pointcloud` | `pointcloud_registration_track_lesson` | `tracks/pointcloud/lesson_36_toy_pointcloud_registration/`, `tests/test_tracks_pointcloud_registration.py` | `README.md`, `tracks/pointcloud/README.md`, `tracks/vision/README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_pointcloud_registration.py`<br>`python scripts/run_lesson.py pointcloud lesson_36_toy_pointcloud_registration --dry-run` |
| L10 | `batch420-world-models-generative` | `.worktrees/batch420-world-models-generative` | `tracks/generative` | `world_models_generative_lesson` | `tracks/generative/lesson_51_toy_world_models/`, `tests/test_tracks_generative_world_models.py` | `README.md`, `tracks/pointcloud/README.md`, `tracks/vision/README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_generative_world_models.py`<br>`python scripts/run_lesson.py generative lesson_51_toy_world_models --dry-run` |
