...
**Goal:** Add `tracks/multimodal/lesson_02_blip_compact_captioning` as a BLIP-lite teaching lesson with synthetic caption generation, image-text matching, and a runnable training script.
...
- `lesson_02_blip_compact_captioning` to appear in `python scripts/run_lesson.py multimodal --list`
- dry-run resolution to `tracks.multimodal.lesson_02_blip_compact_captioning.train`
...
- Create: `tracks/multimodal/lesson_02_blip_compact_captioning/__init__.py`
- Create: `tracks/multimodal/lesson_02_blip_compact_captioning/data.py`
- Create: `tracks/multimodal/lesson_02_blip_compact_captioning/README.md`
...
**Files:**
- Create: `tracks/multimodal/lesson_02_blip_compact_captioning/model.py`
- Test: `tests/test_tracks_multimodal_blip.py`
...
**Files:**
- Create: `tracks/multimodal/lesson_02_blip_compact_captioning/train.py`
- Test: `tests/test_tracks_multimodal_blip.py`
...
`python -m tracks.multimodal.lesson_02_blip_compact_captioning.train --epochs 1 --num-samples 64 --batch-size 8 --image-size 16 --max-train-batches 2 --max-eval-batches 1 --device cpu --run-name pytest_blip_smoke`

Assert that it exits successfully and writes:

- `outputs/multimodal/lesson_02_blip_compact_captioning/pytest_blip_smoke/config.json`
- `outputs/multimodal/lesson_02_blip_compact_captioning/pytest_blip_smoke/metrics.jsonl`
- `outputs/multimodal/lesson_02_blip_compact_captioning/pytest_blip_smoke/checkpoints/checkpoint.pt`
...
- `python scripts/run_lesson.py multimodal lesson_02_blip_compact_captioning --dry-run`
