...
| --- | --- | --- | --- | --- | --- | --- | --- |
| L01 | `batch240-multi-turn-memory-sft` | `.worktrees/batch240-multi-turn-memory-sft` | `tracks/llm` | `multi_turn_memory_sft_llm_lesson` | `tracks/llm/lesson_16_toy_multi_turn_memory_sft/`, `tests/test_tracks_llm_multi_turn_memory.py` | `README.md`, `tracks/llm/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_llm_multi_turn_memory.py`<br>`python scripts/run_lesson.py llm lesson_16_toy_multi_turn_memory_sft --dry-run` |
| L02 | `batch240-self-refine-prompting` | `.worktrees/batch240-self-refine-prompting` | `tracks/llm` | `self_refine_prompting_llm_lesson` | `tracks/llm/lesson_17_toy_self_refine_prompting/`, `tests/test_tracks_llm_self_refine_prompting.py` | `README.md`, `tracks/llm/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_llm_self_refine_prompting.py`<br>`python scripts/run_lesson.py llm lesson_17_toy_self_refine_prompting --dry-run` |
| L03 | `batch240-diffusion-denoising` | `.worktrees/batch240-diffusion-denoising` | `tracks/generative` | `diffusion_denoising_generative_lesson` | `tracks/generative/lesson_17_toy_diffusion_denoising/`, `tests/test_tracks_generative_diffusion_denoising.py` | `README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_generative_diffusion_denoising.py`<br>`python scripts/run_lesson.py generative lesson_17_toy_diffusion_denoising --dry-run` |
| L04 | `batch240-diffusion-deraining` | `.worktrees/batch240-diffusion-deraining` | `tracks/generative` | `diffusion_deraining_generative_lesson` | `tracks/generative/lesson_18_toy_diffusion_deraining/`, `tests/test_tracks_generative_diffusion_deraining.py` | `README.md`, `tracks/generative/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_generative_diffusion_deraining.py`<br>`python scripts/run_lesson.py generative lesson_18_toy_diffusion_deraining --dry-run` |
...
| L09 | `batch240-weak-supervision` | `.worktrees/batch240-weak-supervision` | `tracks/nlp` | `weak_supervision_text_classification_lesson` | `tracks/nlp/lesson_22_toy_weak_supervision_text_classification/`, `tests/test_tracks_nlp_weak_supervision.py` | `README.md`, `tracks/nlp/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_nlp_weak_supervision.py`<br>`python scripts/run_lesson.py nlp lesson_22_toy_weak_supervision_text_classification --dry-run` |
| L10 | `batch240-sentence-denoising` | `.worktrees/batch240-sentence-denoising` | `tracks/nlp` | `sentence_denoising_nlp_lesson` | `tracks/nlp/lesson_23_toy_sentence_denoising_autoencoder/`, `tests/test_tracks_nlp_sentence_denoising.py` | `README.md`, `tracks/nlp/README.md`, `tests/test_scripts_run_lesson.py` | `pytest -q tests/test_tracks_nlp_sentence_denoising.py`<br>`python scripts/run_lesson.py nlp lesson_23_toy_sentence_denoising_autoencoder --dry-run` |
