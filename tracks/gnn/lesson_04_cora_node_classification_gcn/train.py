...
from .model import GCN, ModelConfig
...
def run_training(cfg: TrainConfig) -> int:
    ...
    paths = build_run_paths(
        track="gnn", lesson="lesson_04_cora_node_classification_gcn", run_name=cfg.run_name
    )
    logger = get_logger("gnn.cora_gcn", log_file=paths.logs_dir / "train.log")
    ...
    adj = data.adj.to(device_info.torch_device)
    ...
    ckpt_path = save_checkpoint(
        ...
        optimizer=optimizer,
        epoch=cfg.epochs,
        extra={"track": "gnn", "lesson": "lesson_04_cora_node_classification_gcn"},
    )
