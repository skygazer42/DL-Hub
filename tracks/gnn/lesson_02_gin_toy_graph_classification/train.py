...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="gnn", lesson="lesson_02_gin_toy_graph_classification", run_name=train_cfg.run_name
    )
    logger = get_logger("gnn.toy_gin", log_file=paths.logs_dir / "train.log")
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={"track": "gnn", "lesson": "lesson_02_gin_toy_graph_classification"},
    )
