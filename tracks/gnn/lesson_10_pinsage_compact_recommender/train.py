...
def run_training(cfg: TrainConfig) -> int:
    ...
    paths = build_run_paths(
        track="gnn", lesson="lesson_10_pinsage_compact_recommender", run_name=cfg.run_name
    )
    logger = get_logger("gnn.pinsage_compact", log_file=paths.logs_dir / "train.log")
    ...
    data = build_baseline_recommender_data(data_cfg)
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={"track": "gnn", "lesson": "lesson_10_pinsage_compact_recommender"},
    )
