...
class ToyGraphDataset:
    """Fixed-size toy graphs for graph-level binary classification.
...
def get_dataloaders(config: DataConfig):
    ...
    ds = ToyGraphDataset(num_graphs=config.num_graphs, num_nodes=config.num_nodes, seed=config.seed)
