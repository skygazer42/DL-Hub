...
def build_baseline_hetero_graph(cfg: DataConfig) -> SyntheticHeteroGraph:
...
def generate_walks(graph: SyntheticHeteroGraph, cfg: DataConfig) -> torch.Tensor:
...
def build_training_pairs(cfg: DataConfig) -> tuple[SyntheticHeteroGraph, SkipGramPairs, NegativeSampler]:
    graph = build_baseline_hetero_graph(cfg)
