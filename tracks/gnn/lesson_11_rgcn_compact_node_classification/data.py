...
def load_synthetic_rel_graph(cfg: DataConfig) -> SyntheticRelGraph:
    """Create a synthetic multi-relational directed graph.
...
__all__ = ["DataConfig", "SyntheticRelGraph", "load_synthetic_rel_graph"]
