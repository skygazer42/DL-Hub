...
class FaceAlignmentRegressor(nn.Module):
...
def alignment_regression_loss(predictions: torch.Tensor, targets: torch.Tensor) -> torch.Tensor:
    return torch.nn.functional.mse_loss(predictions, targets)


def mean_alignment_l2_pixels(
