...
from .model import ModelConfig, PrototypicalFewShotRecognizer, episode_accuracy, prototypical_loss
...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 65 (Vision): synthetic episodic few-shot recognition."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="vision",
        lesson="lesson_65_synthetic_few_shot_recognition",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("vision.few_shot_recognition", log_file=paths.logs_dir / "train.log")
