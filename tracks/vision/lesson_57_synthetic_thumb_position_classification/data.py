...
class SyntheticThumbPositionDataset:
    ...
    def __init__(self, cfg: DataConfig) -> None:
        ...
        if int(cfg.num_classes) != 3:
            raise ValueError("This lesson uses exactly 3 classes.")
    ...
    def _sample_params(self, idx: int) -> tuple[int, dict[str, float]]:
        ...
        thumb_dy_scale = (-0.18, -0.02, 0.14)[label]
        ...
        return label, {
            ...
            "thumb_ry": thumb_ry,
            "thumb_dx": thumb_dx,
            "thumb_dy": float(thumb_dy_scale * size + rng.uniform(-0.02, 0.02) * size),
        }
...
__all__ = ["DataConfig", "SyntheticThumbPositionDataset", "get_dataloaders"]
