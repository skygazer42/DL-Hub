...
class SyntheticFaceIdentificationDataset:
    """Synthetic face crops with 5 identity classes."""
...
def get_dataloaders(cfg: DataConfig):
    ...
    dataset = SyntheticFaceIdentificationDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticFaceIdentificationDataset", "get_dataloaders"]
