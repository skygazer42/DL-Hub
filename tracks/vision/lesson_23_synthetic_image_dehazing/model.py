...
class DehazingModel(nn.Module):
    """Tiny residual dehazing model with restoration and transmission heads."""
    ...
    def __init__(self, cfg: ModelConfig) -> None:
        ...
        self.transmission_head = nn.Conv2d(hidden, 1, kernel_size=3, padding=1)
    ...
    def forward(self, x: torch.Tensor) -> dict[str, torch.Tensor]:
        ...
        return {"restored": restored, "transmission": transmission}
...
def dehazing_loss(
    ...
    total_loss = reconstruction_loss + 0.2 * transmission_loss
    parts = {
...
def build_model(cfg: ModelConfig) -> DehazingModel:
    return DehazingModel(cfg)


__all__ = ["DehazingModel", "ModelConfig", "build_model", "dehazing_loss"]
