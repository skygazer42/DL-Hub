...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 05 (Vision): ViT on a compact synthetic dataset."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="vision", lesson="lesson_05_vit_compact_classification", run_name=train_cfg.run_name
    )
    logger = get_logger("vision.compact_vit", log_file=paths.logs_dir / "train.log")
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={"track": "vision", "lesson": "lesson_05_vit_compact_classification"},
    )
