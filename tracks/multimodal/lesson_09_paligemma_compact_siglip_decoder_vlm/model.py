...
class SiglipStyleVisionEncoder(nn.Module):
...
class CompactPaliGemmaModel(nn.Module):
    def __init__(self, cfg: PaliGemmaModelConfig) -> None:
        super().__init__()
        self.cfg = cfg
        self.vision_encoder = SiglipStyleVisionEncoder(int(cfg.vision_width))
