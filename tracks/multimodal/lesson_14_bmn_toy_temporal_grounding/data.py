...
class ToyBmnTemporalGroundingDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader, Vocab]:
    vocab = _build_vocab()
    dataset = ToyBmnTemporalGroundingDataset(cfg, vocab=vocab)
...
__all__ = ["DataConfig", "ToyBmnTemporalGroundingDataset", "Vocab", "get_dataloaders"]
