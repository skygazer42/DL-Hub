# Lesson 04: Grounding-Lite Compact Referring Expressions
...
```bash
python -m tracks.multimodal.lesson_04_grounding_compact_refexp.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu
```

## Outputs

`outputs/multimodal/lesson_04_grounding_compact_refexp/<run_name>/`
