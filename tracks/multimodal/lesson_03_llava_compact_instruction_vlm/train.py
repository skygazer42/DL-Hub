...
from .model import ModelConfig, CompactLLaVAModel, answer_exact_match, answer_token_accuracy, qa_loss
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="multimodal",
        lesson="lesson_03_llava_compact_instruction_vlm",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("multimodal.llava_compact", log_file=paths.logs_dir / "train.log")
