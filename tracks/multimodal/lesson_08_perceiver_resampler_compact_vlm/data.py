...
class SyntheticPerceiverDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader, Vocab]:
    vocab = _build_vocab()
    dataset = SyntheticPerceiverDataset(cfg, vocab=vocab)
...
__all__ = ["DataConfig", "SyntheticPerceiverDataset", "Vocab", "get_dataloaders"]
