...
from .model import GestureReasoningConfig, ToyGestureReasoningModel, compute_accuracy, gesture_loss
...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 52 (Multimodal): toy gesture VLM reasoning.")
