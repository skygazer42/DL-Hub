...
class ToyTwoDtanTemporalGroundingDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader, Vocab]:
    vocab = _build_vocab()
    dataset = ToyTwoDtanTemporalGroundingDataset(cfg, vocab=vocab)
...
__all__ = ["DataConfig", "ToyTwoDtanTemporalGroundingDataset", "Vocab", "get_dataloaders"]
