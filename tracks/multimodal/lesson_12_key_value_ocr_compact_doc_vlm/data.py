...
class SyntheticKeyValueOcrDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader, Vocab]:
    vocab = _build_vocab()
    dataset = SyntheticKeyValueOcrDataset(cfg, vocab=vocab)
...
__all__ = ["DataConfig", "SyntheticKeyValueOcrDataset", "Vocab", "get_dataloaders"]
