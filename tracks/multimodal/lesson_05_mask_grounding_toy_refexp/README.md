# Lesson 05: Mask-Grounding-Lite Toy Referring Expressions
...
```bash
python -m tracks.multimodal.lesson_05_mask_grounding_toy_refexp.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu
```

## Outputs

`outputs/multimodal/lesson_05_mask_grounding_toy_refexp/<run_name>/`
