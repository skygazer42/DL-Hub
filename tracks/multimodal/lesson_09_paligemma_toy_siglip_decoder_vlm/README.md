# Lesson 09: PaliGemma-Lite Toy SigLIP Decoder VLM
...
```bash
python -m tracks.multimodal.lesson_09_paligemma_toy_siglip_decoder_vlm.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu
```
