...
class SyntheticFaceVerificationDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader[dict[str, object]], DataLoader[dict[str, object]], Vocab]:
    vocab = _build_vocab()
    dataset = SyntheticFaceVerificationDataset(cfg, vocab=vocab)
...
__all__ = ["DataConfig", "SyntheticFaceVerificationDataset", "Vocab", "get_dataloaders"]
