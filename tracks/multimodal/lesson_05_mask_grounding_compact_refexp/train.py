...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="multimodal",
        lesson="lesson_05_mask_grounding_compact_refexp",
        run_name=train_cfg.run_name,
    )
    logger = get_logger(
        "multimodal.mask_grounding_compact",
...
def main() -> int:
    if __package__ is None:
        raise RuntimeError(
            ...
            "  python -m tracks.multimodal.lesson_05_mask_grounding_compact_refexp.train"
        )
