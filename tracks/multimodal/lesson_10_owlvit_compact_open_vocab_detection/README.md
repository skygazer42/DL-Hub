# Lesson 10: OWL-ViT-Lite Compact Open-Vocabulary Detection
...
```bash
python -m tracks.multimodal.lesson_10_owlvit_compact_open_vocab_detection.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu
```
