...
class SyntheticFlamingoDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader, Vocab]:
    vocab = _build_vocab()
    dataset = SyntheticFlamingoDataset(cfg, vocab=vocab)
...
__all__ = ["DataConfig", "SyntheticFlamingoDataset", "Vocab", "get_dataloaders"]
