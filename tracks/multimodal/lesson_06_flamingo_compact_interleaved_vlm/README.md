# Lesson 06: Flamingo-Lite Compact Interleaved VLM
...
```bash
python -m tracks.multimodal.lesson_06_flamingo_compact_interleaved_vlm.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu
```
