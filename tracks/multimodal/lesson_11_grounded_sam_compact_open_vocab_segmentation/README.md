# Lesson 11: Grounded-SAM-Lite Compact Open-Vocabulary Segmentation
...
```bash
python -m tracks.multimodal.lesson_11_grounded_sam_compact_open_vocab_segmentation.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu
```
