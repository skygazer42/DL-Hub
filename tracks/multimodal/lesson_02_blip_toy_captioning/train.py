...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="multimodal",
        lesson="lesson_02_blip_toy_captioning",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("multimodal.blip_toy", log_file=paths.logs_dir / "train.log")
...
def main() -> int:
    if __package__ is None:
        raise RuntimeError(
            ...
            "  python -m tracks.multimodal.lesson_02_blip_toy_captioning.train"
        )
