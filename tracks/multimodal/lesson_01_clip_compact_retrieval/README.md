# Lesson 01: CLIP-Style Compact Retrieval
...
```bash
python -m tracks.multimodal.lesson_01_clip_compact_retrieval.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu
```

## Outputs

`outputs/multimodal/lesson_01_clip_compact_retrieval/<run_name>/`
