...
class ToyMultiScaleTwoDtanTemporalGroundingDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader, Vocab]:
    vocab = _build_vocab()
    dataset = ToyMultiScaleTwoDtanTemporalGroundingDataset(cfg, vocab=vocab)
...
__all__ = ["DataConfig", "ToyMultiScaleTwoDtanTemporalGroundingDataset", "Vocab", "get_dataloaders"]
