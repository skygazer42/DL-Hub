...
from .model import FingerCountReasoningConfig, ToyFingerCountReasoningModel, compute_accuracy, finger_count_loss
...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 53 (Multimodal): toy finger-count VLM reasoning.")
