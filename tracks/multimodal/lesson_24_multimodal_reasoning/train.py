...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    ...
    parser.add_argument("--max-facts-length", type=int, default=12)
    ...
    data_cfg = DataConfig(
        ...
        max_facts_length=args.max_facts_length,
...
def _run_epoch(
    *,
    ...
    for step, batch in enumerate(loader):
        ...
        total_acc += classification_accuracy(outputs["logits"], moved["labels"]) * batch_size
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={"track": "multimodal", "lesson": "lesson_24_multimodal_reasoning"},
    )
