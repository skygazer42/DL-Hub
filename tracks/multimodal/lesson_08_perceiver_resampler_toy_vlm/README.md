# Lesson 08: Perceiver-Resampler-Lite Toy VLM
...
```bash
python -m tracks.multimodal.lesson_08_perceiver_resampler_toy_vlm.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu
```
