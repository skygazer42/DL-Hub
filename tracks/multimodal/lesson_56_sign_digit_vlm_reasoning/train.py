...
from .model import SignDigitReasoningConfig, ToySignDigitReasoningModel, compute_accuracy, sign_digit_loss
...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 56 (Multimodal): toy sign-digit VLM reasoning.")
