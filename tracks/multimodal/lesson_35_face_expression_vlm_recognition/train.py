...
def _run_epoch(
    *,
    ...
    for step, batch in enumerate(loader):
        ...
        batch_size = int(batch["face_features"].shape[0])
    ...
    return Stats(loss=total_loss / total_examples, acc=total_acc / total_examples)
        ...
        rows.append(
            {
                ...
                "emotion_label": batch["emotion_label"][idx],
                "target_label": target_id,
                "target_emotion": EMOTIONS[target_id],
                "pred_label": pred_id,
                "pred_emotion": EMOTIONS[pred_id],
            }
        )
...
def main() -> int:
    if __package__ is None:
        raise RuntimeError(
            ...
            "  python -m tracks.multimodal.lesson_35_face_expression_vlm_recognition.train"
        )
