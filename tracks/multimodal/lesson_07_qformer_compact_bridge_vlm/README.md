# Lesson 07: Q-Former-Lite Compact Bridge VLM
...
```bash
python -m tracks.multimodal.lesson_07_qformer_compact_bridge_vlm.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu
```
