...
def _make_toy_ner_examples(num_samples: int, seed: int) -> list[tuple[list[str], list[str]]]:
...
def get_dataloaders(config: DataConfig):
    ...
    examples = _make_toy_ner_examples(num_samples=config.num_samples, seed=config.seed)
...
__all__ = ["DataConfig", "TagVocab", "ToyNerDataset", "Vocab", "get_dataloaders"]
