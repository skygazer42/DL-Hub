...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 12 (NLP): compact in-context text classification without gradient updates."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    logger = get_logger("nlp.compact_in_context_text", log_file=paths.logs_dir / "train.log")
