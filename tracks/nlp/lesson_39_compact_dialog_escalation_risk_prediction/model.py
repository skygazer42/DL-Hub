...
class DialogEscalationRiskClassifier(nn.Module):
    def __init__(self, config: ModelConfig) -> None:
        ...
        self.head = nn.Linear(int(config.embed_dim), int(config.num_risk_levels))
...
def dialog_escalation_risk_loss(logits: torch.Tensor, labels: torch.Tensor) -> torch.Tensor:
...
__all__ = ["DialogEscalationRiskClassifier", "ModelConfig", "compute_accuracy", "dialog_escalation_risk_loss"]
