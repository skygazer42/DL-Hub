...
class DialogResolutionOwnerClassifier(nn.Module):
    def __init__(self, config: ModelConfig) -> None:
        ...
        self.head = nn.Linear(int(config.embed_dim), int(config.num_owners))
...
def dialog_resolution_owner_loss(logits: torch.Tensor, labels: torch.Tensor) -> torch.Tensor:
