...
from tracks.nlp.synthetic_seq2seq import Vocab
...
class SyntheticSummarizationDataset:
    def __init__(
...
def get_dataloaders(cfg: DataConfig):
    ...
    ds = SyntheticSummarizationDataset(examples=examples, vocab=vocab, cfg=cfg)
...
__all__ = ["DataConfig", "Vocab", "SyntheticSummarizationDataset", "get_dataloaders"]
