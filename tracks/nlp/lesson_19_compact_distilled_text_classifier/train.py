...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 19 (NLP): compact distilled text classifier.")
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp",
        lesson="lesson_19_compact_distilled_text_classifier",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("nlp.compact_distilled_text_classifier", log_file=paths.logs_dir / "train.log")
