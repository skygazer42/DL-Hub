...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 01 (NLP): toy text classification.")
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp", lesson="lesson_01_toy_text_classification", run_name=train_cfg.run_name
    )
    logger = get_logger("nlp.toy_text_cls", log_file=paths.logs_dir / "train.log")
