...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp", lesson="lesson_05_toy_text_classification_textcnn", run_name=train_cfg.run_name
    )
    logger = get_logger("nlp.toy_textcnn", log_file=paths.logs_dir / "train.log")
...
def main() -> int:
    if __package__ is None:
        raise RuntimeError(
            ...
            "  python -m tracks.nlp.lesson_05_toy_text_classification_textcnn.train"
        )
