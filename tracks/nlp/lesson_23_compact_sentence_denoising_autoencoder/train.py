...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 23 (NLP): compact sentence denoising autoencoder."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp",
        lesson="lesson_23_compact_sentence_denoising_autoencoder",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("nlp.compact_sentence_denoising", log_file=paths.logs_dir / "train.log")
    ...
    save_checkpoint(
        ...
        extra={"track": "nlp", "lesson": "lesson_23_compact_sentence_denoising_autoencoder"},
    )
    return 0
