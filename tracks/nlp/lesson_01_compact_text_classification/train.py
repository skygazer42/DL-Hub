...
from .model import MeanPoolTextClassifier, ModelConfig
...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 01 (NLP): compact text classification.")
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp", lesson="lesson_01_compact_text_classification", run_name=train_cfg.run_name
    )
    logger = get_logger("nlp.compact_text_cls", log_file=paths.logs_dir / "train.log")
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={
            "track": "nlp",
            "lesson": "lesson_01_compact_text_classification",
            "vocab_size": vocab.size,
        },
    )
