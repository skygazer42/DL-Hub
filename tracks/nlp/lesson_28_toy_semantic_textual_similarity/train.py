...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 28 (NLP): toy semantic textual similarity.")
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp",
        lesson="lesson_28_toy_semantic_textual_similarity",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("nlp.toy_semantic_textual_similarity", log_file=paths.logs_dir / "train.log")
    ...
    save_checkpoint(
        ...
        extra={"track": "nlp", "lesson": "lesson_28_toy_semantic_textual_similarity", "vocab_size": vocab.size},
    )
    return 0
...
def main() -> int:
    if __package__ is None:
        raise RuntimeError(
            ...
            "  python -m tracks.nlp.lesson_28_toy_semantic_textual_similarity.train"
        )
