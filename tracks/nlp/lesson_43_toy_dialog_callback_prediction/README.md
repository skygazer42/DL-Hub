# Lesson 43: Toy Dialog Callback Prediction
...
```bash
python -m tracks.nlp.lesson_43_toy_dialog_callback_prediction.train --device cpu --epochs 1
```

Outputs are written to
`outputs/nlp/lesson_43_toy_dialog_callback_prediction/<run_name>/`.
