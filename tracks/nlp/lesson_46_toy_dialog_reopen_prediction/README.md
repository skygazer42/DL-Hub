# Lesson 46: Toy Dialog Reopen Prediction
...
```bash
python -m tracks.nlp.lesson_46_toy_dialog_reopen_prediction.train --device cpu --epochs 1
```

Outputs land under `outputs/nlp/lesson_46_toy_dialog_reopen_prediction/<run_name>/`.
