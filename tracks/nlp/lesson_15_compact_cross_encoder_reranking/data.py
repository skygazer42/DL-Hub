...
class SyntheticCrossEncoderDataset:
    def __init__(
        self,
        *,
        triplets: list[tuple[str, str, str]],
...
def get_dataloaders(cfg: DataConfig):
    ...
    dataset = SyntheticCrossEncoderDataset(triplets=triplets, vocab=vocab, cfg=cfg)
...
__all__ = ["DataConfig", "SyntheticCrossEncoderDataset", "Vocab", "get_dataloaders"]
