# Lesson 41: Compact Dialog Transfer Prediction
...
```bash
python -m tracks.nlp.lesson_41_compact_dialog_transfer_prediction.train --device cpu --epochs 1
```

Outputs are written to
`outputs/nlp/lesson_41_compact_dialog_transfer_prediction/<run_name>/`.
