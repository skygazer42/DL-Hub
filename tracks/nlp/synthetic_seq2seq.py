...
def get_dataloaders(cfg: DataConfig):
    """Return `(train_loader, val_loader, vocab)` for the synthetic seq2seq task."""
    ...
    ds = SyntheticSeq2SeqDataset(examples=examples, vocab=vocab, cfg=cfg)
...
__all__ = ["DataConfig", "Vocab", "SyntheticSeq2SeqDataset", "get_dataloaders"]
