...
class DialogPriorityClassifier(nn.Module):
    def __init__(self, config: ModelConfig) -> None:
        ...
        self.head = nn.Linear(int(config.embed_dim), int(config.num_priority_levels))
...
def dialog_priority_loss(logits: torch.Tensor, labels: torch.Tensor) -> torch.Tensor:
...
__all__ = ["DialogPriorityClassifier", "ModelConfig", "compute_accuracy", "dialog_priority_loss"]
