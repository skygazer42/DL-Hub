...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 16 (NLP): compact text clustering.")
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp",
        lesson="lesson_16_compact_text_clustering",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("nlp.compact_text_clustering", log_file=paths.logs_dir / "train.log")
    ...
    save_checkpoint(
        ...
        extra={"track": "nlp", "lesson": "lesson_16_compact_text_clustering", "vocab_size": vocab.size},
    )
    return 0
