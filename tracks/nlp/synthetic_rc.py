...
def get_dataloaders(cfg: DataConfig):
    """Return `(train_loader, val_loader, vocab)` for the synthetic reading comprehension task."""
    ...
    ds = SyntheticRCDataset(examples=examples, vocab=vocab, cfg=cfg)
...
__all__ = ["DataConfig", "Vocab", "SyntheticRCDataset", "get_dataloaders"]
