# Lesson 40: Toy Dialog Priority Prediction
...
included to keep the toy vocabulary interpretable.

## Run

```bash
python -m tracks.nlp.lesson_40_toy_dialog_priority_prediction.train --device cpu --epochs 1
```

Outputs land under `outputs/nlp/lesson_40_toy_dialog_priority_prediction/<run_name>/`.
