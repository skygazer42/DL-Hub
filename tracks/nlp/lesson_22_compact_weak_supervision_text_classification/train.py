...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 22 (NLP): compact weak-supervision text classification."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp",
        lesson="lesson_22_compact_weak_supervision_text_classification",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("nlp.compact_weak_supervision", log_file=paths.logs_dir / "train.log")
    ...
    save_checkpoint(
        ...
        extra={"track": "nlp", "lesson": "lesson_22_compact_weak_supervision_text_classification"},
    )
    return 0
