...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 17 (NLP): compact text anomaly detection.")
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp",
        lesson="lesson_17_compact_text_anomaly_detection",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("nlp.compact_text_anomaly_detection", log_file=paths.logs_dir / "train.log")
