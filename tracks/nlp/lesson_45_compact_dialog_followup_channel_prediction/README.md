# Lesson 45: Compact Dialog Followup Channel Prediction
...
```bash
python -m tracks.nlp.lesson_45_compact_dialog_followup_channel_prediction.train --device cpu --epochs 1
```

Outputs land under
`outputs/nlp/lesson_45_compact_dialog_followup_channel_prediction/<run_name>/`.
