...
class DialogFollowupChannelClassifier(nn.Module):
    def __init__(self, config: ModelConfig) -> None:
        ...
        self.head = nn.Linear(int(config.embed_dim), int(config.num_channels))
...
def dialog_followup_channel_loss(logits: torch.Tensor, labels: torch.Tensor) -> torch.Tensor:
