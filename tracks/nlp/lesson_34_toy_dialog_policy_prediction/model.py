...
class DialogPolicyClassifier(nn.Module):
    def __init__(self, config: ModelConfig) -> None:
        ...
        self.head = nn.Linear(int(config.embed_dim), int(config.num_policies))
...
def dialog_policy_loss(logits: torch.Tensor, labels: torch.Tensor) -> torch.Tensor:
...
__all__ = ["DialogPolicyClassifier", "ModelConfig", "compute_accuracy", "dialog_policy_loss"]
