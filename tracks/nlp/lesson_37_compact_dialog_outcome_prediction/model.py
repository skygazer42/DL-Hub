...
class DialogOutcomeClassifier(nn.Module):
    def __init__(self, config: ModelConfig) -> None:
        ...
        self.head = nn.Linear(int(config.embed_dim), int(config.num_outcomes))
...
def dialog_outcome_loss(logits: torch.Tensor, labels: torch.Tensor) -> torch.Tensor:
...
__all__ = ["DialogOutcomeClassifier", "ModelConfig", "compute_accuracy", "dialog_outcome_loss"]
