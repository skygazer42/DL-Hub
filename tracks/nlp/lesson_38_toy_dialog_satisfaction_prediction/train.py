...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 38 (NLP): toy dialog satisfaction prediction.")
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp",
        lesson="lesson_38_toy_dialog_satisfaction_prediction",
        run_name=train_cfg.run_name,
    )
    logger = get_logger(
        "nlp.toy_dialog_satisfaction_prediction",
...
def main() -> int:
    if __package__ is None:
        raise RuntimeError(
            ...
            "  python -m tracks.nlp.lesson_38_toy_dialog_satisfaction_prediction.train"
        )
