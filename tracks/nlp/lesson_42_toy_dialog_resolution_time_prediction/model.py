...
class DialogResolutionTimeClassifier(nn.Module):
    def __init__(self, config: ModelConfig) -> None:
        ...
        self.head = nn.Linear(int(config.embed_dim), int(config.num_time_buckets))
...
def dialog_resolution_time_loss(logits: torch.Tensor, labels: torch.Tensor) -> torch.Tensor:
