# Lesson 42: Toy Dialog Resolution Time Prediction
...
```bash
python -m tracks.nlp.lesson_42_toy_dialog_resolution_time_prediction.train --device cpu --epochs 1
```

Outputs are written to
`outputs/nlp/lesson_42_toy_dialog_resolution_time_prediction/<run_name>/`.
