# Lesson 44: Compact Dialog SLA Breach Prediction
...
```bash
python -m tracks.nlp.lesson_44_compact_dialog_sla_breach_prediction.train --device cpu --epochs 1
```

Outputs are written to
`outputs/nlp/lesson_44_compact_dialog_sla_breach_prediction/<run_name>/`.
