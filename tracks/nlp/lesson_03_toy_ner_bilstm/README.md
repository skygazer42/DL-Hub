...
```bash
python -m tracks.nlp.lesson_03_toy_ner_bilstm.train --epochs 1 --max-train-batches 2 --max-eval-batches 1 --device cpu --run-name smoke
```

## 输出产物（统一规范）

`outputs/nlp/lesson_03_toy_ner_bilstm/<run_name>/`
