...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 21 (NLP): compact adversarial example detection."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="nlp",
        lesson="lesson_21_compact_adversarial_example_detection",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("nlp.compact_adversarial_example_detection", log_file=paths.logs_dir / "train.log")
