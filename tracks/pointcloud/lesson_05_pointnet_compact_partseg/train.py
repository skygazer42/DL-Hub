...
from .model import ModelConfig, PointNetPartSeg
...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 05 (PointCloud): PointNet compact part segmentation."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="pointcloud", lesson="lesson_05_pointnet_compact_partseg", run_name=train_cfg.run_name
    )
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={"track": "pointcloud", "lesson": "lesson_05_pointnet_compact_partseg"},
    )
