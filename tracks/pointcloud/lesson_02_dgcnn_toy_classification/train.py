...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="pointcloud", lesson="lesson_02_dgcnn_toy_classification", run_name=train_cfg.run_name
    )
    logger = get_logger("pointcloud.toy_dgcnn", log_file=paths.logs_dir / "train.log")
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={"track": "pointcloud", "lesson": "lesson_02_dgcnn_toy_classification"},
    )
