...
def build_model(cfg: ModelConfig) -> nn.Module:
    ...
    if arch in {"pointnet", "pointnet_partseg"}:
        from tracks.pointcloud.lesson_05_pointnet_toy_partseg.model import ModelConfig as PNConfig
        from tracks.pointcloud.lesson_05_pointnet_toy_partseg.model import PointNetPartSeg
    ...
    if arch in {"dgcnn", "dgcnn_partseg", "dgcnn_static"}:
        from tracks.pointcloud.lesson_06_dgcnn_toy_partseg.model import DGCNNPartSeg
        from tracks.pointcloud.lesson_06_dgcnn_toy_partseg.model import ModelConfig as DGCNNConfig
