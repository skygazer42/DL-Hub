...
from .model import ModelConfig, PointNet2Classifier
...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 03 (PointCloud): PointNet2 compact classification (Cube vs Sphere)."
    )
    ...
    parser.add_argument("--npoint1", type=int, default=32)
    parser.add_argument("--k1", type=int, default=16)
    parser.add_argument("--npoint2", type=int, default=8)
    parser.add_argument("--k2", type=int, default=8)
    ...
    train_cfg = TrainConfig(
        ...
        npoint1=args.npoint1,
        k1=args.k1,
        npoint2=args.npoint2,
        k2=args.k2,
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="pointcloud",
        lesson="lesson_03_pointnet2_compact_classification",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("pointcloud.compact_pointnet2", log_file=paths.logs_dir / "train.log")
    ...
    write_json(
        paths.run_dir / "config.json",
        {
            ...
            "model": dataclass_to_dict(
                ModelConfig(
                    npoint1=train_cfg.npoint1,
                    k1=train_cfg.k1,
                    npoint2=train_cfg.npoint2,
                    k2=train_cfg.k2,
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={"track": "pointcloud", "lesson": "lesson_03_pointnet2_compact_classification"},
    )
