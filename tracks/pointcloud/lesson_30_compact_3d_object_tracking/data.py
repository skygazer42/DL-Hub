...
class SyntheticObjectTrackingDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset = SyntheticObjectTrackingDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticObjectTrackingDataset", "get_dataloaders"]
