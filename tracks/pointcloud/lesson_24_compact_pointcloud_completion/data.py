...
class SyntheticPointCloudCompletionDataset(Dataset):
    """Synthetic partial-to-complete pointcloud completion pairs."""
...
__all__ = ["DataConfig", "SyntheticPointCloudCompletionDataset", "get_dataloaders"]
