...
class SyntheticOpenVocabulary3DDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset = SyntheticOpenVocabulary3DDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticOpenVocabulary3DDataset", "get_dataloaders"]
