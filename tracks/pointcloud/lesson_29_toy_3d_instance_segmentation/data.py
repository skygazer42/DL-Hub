...
class ToyInstanceSegmentation3DDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset = ToyInstanceSegmentation3DDataset(cfg)
...
__all__ = ["DataConfig", "ToyInstanceSegmentation3DDataset", "get_dataloaders"]
