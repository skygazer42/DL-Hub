...
class SyntheticSemanticSegmentation3DDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset = SyntheticSemanticSegmentation3DDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticSemanticSegmentation3DDataset", "get_dataloaders"]
