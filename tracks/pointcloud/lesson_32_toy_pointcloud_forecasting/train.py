...
def parse_args() -> tuple[TrainConfig, DataConfig, ModelConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 32 (PointCloud): toy pointcloud forecasting."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig, model_cfg: ModelConfig) -> int:
    ...
    paths = build_run_paths(
        track="pointcloud",
        lesson="lesson_32_toy_pointcloud_forecasting",
    ...
    save_checkpoint(
        ...
        extra={"track": "pointcloud", "lesson": "lesson_32_toy_pointcloud_forecasting"},
    )
    return 0
...
def main() -> int:
    if __package__ is None:
        raise RuntimeError(
            ...
            "  python -m tracks.pointcloud.lesson_32_toy_pointcloud_forecasting.train"
        )
