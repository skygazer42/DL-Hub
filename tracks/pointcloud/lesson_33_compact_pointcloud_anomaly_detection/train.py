...
def parse_args() -> tuple[TrainConfig, DataConfig, ModelConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 33 (PointCloud): compact pointcloud anomaly detection."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig, model_cfg: ModelConfig) -> int:
    ...
    paths = build_run_paths(
        track="pointcloud",
        lesson="lesson_33_compact_pointcloud_anomaly_detection",
    ...
    save_checkpoint(
        ...
        extra={"track": "pointcloud", "lesson": "lesson_33_compact_pointcloud_anomaly_detection"},
    )
    return 0
...
def main() -> int:
    if __package__ is None:
        raise RuntimeError(
            ...
            "  python -m tracks.pointcloud.lesson_33_compact_pointcloud_anomaly_detection.train"
        )
