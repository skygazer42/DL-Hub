...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(
        description="Lesson 06 (PointCloud): DGCNN compact part segmentation."
    )
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="pointcloud", lesson="lesson_06_dgcnn_compact_partseg", run_name=train_cfg.run_name
    )
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={"track": "pointcloud", "lesson": "lesson_06_dgcnn_compact_partseg"},
    )
