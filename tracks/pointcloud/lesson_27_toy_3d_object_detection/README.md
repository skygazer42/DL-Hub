# Lesson 27: Toy 3D Object Detection
...
```bash
python -m tracks.pointcloud.lesson_27_toy_3d_object_detection.train --run-name dev
python scripts/run_lesson.py pointcloud lesson_27_toy_3d_object_detection --dry-run
```

## Outputs

Runs are written to `outputs/pointcloud/lesson_27_toy_3d_object_detection/<run-name>/`
