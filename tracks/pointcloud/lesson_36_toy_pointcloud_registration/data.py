...
class ToyPointCloudRegistrationDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset = ToyPointCloudRegistrationDataset(cfg)
...
__all__ = ["DataConfig", "ToyPointCloudRegistrationDataset", "get_dataloaders"]
