...
class ToyGaussianSplattingDataset(Dataset):
    """Synthetic point-cloud-to-image supervision for toy Gaussian splatting."""
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset = ToyGaussianSplattingDataset(cfg)
...
__all__ = ["DataConfig", "ToyGaussianSplattingDataset", "get_dataloaders"]
