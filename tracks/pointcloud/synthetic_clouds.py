...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds = SyntheticPointCloudDataset(cfg)
...
class SyntheticPartSegDataset(Dataset):
...
def get_partseg_dataloaders(cfg: PartSegDataConfig) -> tuple[DataLoader, DataLoader]:
    ds = SyntheticPartSegDataset(cfg)
    train_idx, val_idx = train_val_split_indices(
        n=len(ds), val_fraction=cfg.val_fraction, seed=cfg.seed
    )
...
class SyntheticReconDataset(Dataset):
    """Synthetic point cloud reconstruction: noisy -> clean (set-to-set).
...
__all__ = [
    ...
    "PartSegDataConfig",
    "ReconDataConfig",
    "SyntheticReconDataset",
    "SyntheticPartSegDataset",
