# Lesson 04: Compact Instruction Tuning

This lesson turns the tiny causal LM from lesson 01 into a single-turn instruction-following compact.
...
```bash
python -m tracks.llm.lesson_04_compact_instruction_tuning.train --device cpu --epochs 1
```
