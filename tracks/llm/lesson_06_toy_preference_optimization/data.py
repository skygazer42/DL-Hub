...
def get_dataloaders(cfg: DataConfig):
    ...
    if int(cfg.seq_length) < 10:
        raise ValueError("seq_length must be >= 10 for the toy preference template")

    vocab = Vocab(base_vocab_size=int(cfg.base_vocab_size))
    arrays = _make_dataset_arrays(cfg, vocab)
    ds = ToyPreferenceDataset(
...
__all__ = ["DataConfig", "ToyPreferenceDataset", "Vocab", "get_dataloaders"]
