# Lesson 39: Toy CSV Constrained Prompting
...
```bash
python -m tracks.llm.lesson_39_toy_csv_constrained_prompting.train --epochs 1 --device cpu
```

Outputs are written under
`outputs/llm/lesson_39_toy_csv_constrained_prompting/<run_name>/`.
