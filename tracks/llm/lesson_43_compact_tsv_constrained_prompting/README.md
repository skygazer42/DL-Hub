# Lesson 43: Compact TSV Constrained Prompting
...
```bash
python -m tracks.llm.lesson_43_compact_tsv_constrained_prompting.train --epochs 1 --device cpu
```

Outputs are written under `outputs/llm/lesson_43_compact_tsv_constrained_prompting/<run_name>/`.
