...
class CompactLlmJudge(nn.Module):
    def __init__(self, cfg: ModelConfig) -> None:
        ...
        self.judge_head = nn.Linear(int(cfg.hidden_dim), 1)
    ...
    def forward(self, *, input_ids: torch.Tensor, attention_mask: torch.Tensor) -> dict[str, torch.Tensor]:
        ...
        judge_logits = self.judge_head(pooled).squeeze(-1)
        return {"token_logits": token_logits, "judge_logits": judge_logits}


__all__ = ["ModelConfig", "CompactLlmJudge"]
