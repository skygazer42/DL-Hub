...
def get_dataloaders(cfg: DataConfig):
    """Return `(train_loader, val_loader, vocab)` for the synthetic LM task."""
    ...
    ds = SyntheticLMDataset(sequences=sequences, vocab=vocab)
...
__all__ = ["DataConfig", "Vocab", "SyntheticLMDataset", "get_dataloaders"]
