# Lesson 36: Toy EBNF Constrained Prompting
...
```bash
python -m tracks.llm.lesson_36_toy_ebnf_constrained_prompting.train --epochs 1 --device cpu
```

Outputs are written under
`outputs/llm/lesson_36_toy_ebnf_constrained_prompting/<run_name>/`.
