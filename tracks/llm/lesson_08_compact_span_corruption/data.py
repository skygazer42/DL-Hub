...
class SyntheticSpanCorruptionDataset:
    def __init__(
        self,
        *,
...
def get_dataloaders(cfg: DataConfig):
    ...
    if int(cfg.seq_length) < 8:
        raise ValueError("seq_length must be >= 8 for synthetic span-corruption sequences")
    ...
    ds = SyntheticSpanCorruptionDataset(input_ids=input_ids, attention_mask=attention_mask, labels=labels)
...
__all__ = ["DataConfig", "SyntheticSpanCorruptionDataset", "Vocab", "get_dataloaders"]
