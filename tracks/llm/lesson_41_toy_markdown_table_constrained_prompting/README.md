# Lesson 41: Toy Markdown-Table Constrained Prompting
...
```bash
python -m tracks.llm.lesson_41_toy_markdown_table_constrained_prompting.train --epochs 1 --device cpu
```

Outputs are written under
`outputs/llm/lesson_41_toy_markdown_table_constrained_prompting/<run_name>/`.
