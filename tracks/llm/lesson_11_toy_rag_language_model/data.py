...
class ToyRagLanguageModelDataset:
...
def get_dataloaders(cfg: DataConfig):
    ...
    if int(cfg.seq_length) < 8:
        raise ValueError("seq_length must be >= 8 for toy RAG LM sequences")
    ...
    ds = ToyRagLanguageModelDataset(input_ids=input_ids, labels=labels, doc_ids=doc_ids, vocab=vocab)
...
__all__ = ["DataConfig", "ToyRagLanguageModelDataset", "Vocab", "get_dataloaders"]
