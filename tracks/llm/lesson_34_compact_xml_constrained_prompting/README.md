# Lesson 34: Compact XML Constrained Prompting
...
```bash
python -m tracks.llm.lesson_34_compact_xml_constrained_prompting.train --epochs 1 --device cpu
```

Outputs are written under
`outputs/llm/lesson_34_compact_xml_constrained_prompting/<run_name>/`.
