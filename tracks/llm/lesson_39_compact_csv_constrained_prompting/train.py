...
def parse_args() -> tuple[TrainConfig, DataConfig]:
    parser = argparse.ArgumentParser(description="Lesson 39 (LLM): compact CSV constrained prompting.")
...
def run_training(train_cfg: TrainConfig, data_cfg: DataConfig) -> int:
    ...
    paths = build_run_paths(
        track="llm",
        lesson="lesson_39_compact_csv_constrained_prompting",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("llm.compact_csv_constrained_prompting", log_file=paths.logs_dir / "train.log")
