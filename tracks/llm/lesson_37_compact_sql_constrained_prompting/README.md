# Lesson 37: Compact SQL Constrained Prompting
...
```bash
python -m tracks.llm.lesson_37_compact_sql_constrained_prompting.train --epochs 1 --device cpu
```

Outputs are written under
`outputs/llm/lesson_37_compact_sql_constrained_prompting/<run_name>/`.
