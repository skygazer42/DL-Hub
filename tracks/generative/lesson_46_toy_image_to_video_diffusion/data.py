...
def _make_toy_image_to_video_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
class ToyImageToVideoDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._source, self._video = _make_toy_image_to_video_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyImageToVideoDataset(cfg)
...
__all__ = ["DataConfig", "ToyImageToVideoDataset", "get_dataloaders"]
