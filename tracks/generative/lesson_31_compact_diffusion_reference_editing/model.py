...
class CompactReferenceEditingDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        features = torch.cat([xt, source, reference, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, source=source, reference=reference, timesteps=t)
...
__all__ = ["DiffusionSchedule", "ModelConfig", "CompactReferenceEditingDiffusionModel", "q_sample"]
