...
class SyntheticTextToVideoDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = SyntheticTextToVideoDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticTextToVideoDataset", "get_dataloaders"]
