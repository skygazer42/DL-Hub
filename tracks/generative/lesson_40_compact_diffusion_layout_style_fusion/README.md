# Lesson 40: Compact Diffusion Layout-Style Fusion
...
```bash
python -m tracks.generative.lesson_40_compact_diffusion_layout_style_fusion.train --epochs 1 --device cpu
```

Outputs are written under
`outputs/generative/lesson_40_compact_diffusion_layout_style_fusion/<run_name>/`.
