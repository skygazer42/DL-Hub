...
class ToyImageFusionDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._obs_a, self._obs_b, self._target = _make_toy_image_fusion_data(cfg)
...
def _make_toy_image_fusion_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = ToyImageFusionDataset(cfg)
