...
class CompactImageVariationDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        fused = torch.cat([xt, source, t_map], dim=1)
...
__all__ = ["DiffusionSchedule", "ModelConfig", "CompactImageVariationDiffusionModel", "q_sample"]
