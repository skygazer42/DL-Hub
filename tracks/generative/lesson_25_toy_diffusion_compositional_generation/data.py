...
class ToyCompositionalGenerationDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._structure, self._style, self._target = _make_toy_compositional_data(cfg)
...
def _make_toy_compositional_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyCompositionalGenerationDataset(cfg)
...
__all__ = ["DataConfig", "ToyCompositionalGenerationDataset", "get_dataloaders"]
