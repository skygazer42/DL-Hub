...
def _make_toy_text_to_3d_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class ToyTextTo3DDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._text, self._density, self._mesh_tokens = _make_toy_text_to_3d_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyTextTo3DDataset(cfg)
...
__all__ = ["DataConfig", "ToyTextTo3DDataset", "get_dataloaders"]
