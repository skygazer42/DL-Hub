...
class SyntheticReferenceGuidedGenerationDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._reference, self._condition, self._target = _make_synthetic_reference_guided_data(cfg)
...
def _make_synthetic_reference_guided_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = SyntheticReferenceGuidedGenerationDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticReferenceGuidedGenerationDataset", "get_dataloaders"]
