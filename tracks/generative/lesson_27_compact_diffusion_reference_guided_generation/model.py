...
class CompactReferenceGuidedDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        features = torch.cat([xt, reference, condition, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, reference=reference, condition=condition, timesteps=t)
...
__all__ = ["DiffusionSchedule", "ModelConfig", "CompactReferenceGuidedDiffusionModel", "q_sample"]
