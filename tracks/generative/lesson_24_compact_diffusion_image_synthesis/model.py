...
class CompactImageSynthesisDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        fused = torch.cat([xt, condition, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, condition=condition, timesteps=t)
...
__all__ = ["DiffusionSchedule", "ModelConfig", "CompactImageSynthesisDiffusionModel", "q_sample"]
