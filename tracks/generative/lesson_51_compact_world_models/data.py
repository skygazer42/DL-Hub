...
class SyntheticWorldModelsDataset(Dataset):
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = SyntheticWorldModelsDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticWorldModelsDataset", "get_dataloaders"]
