...
def _make_synthetic_layout_preserving_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class SyntheticLayoutPreservingEditingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._layout, self._edit, self._target = _make_synthetic_layout_preserving_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = SyntheticLayoutPreservingEditingDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticLayoutPreservingEditingDataset", "get_dataloaders"]
