...
class CompactLayoutPreservingDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        features = torch.cat([xt, layout, edit, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        edit = edit.to(device=device, dtype=torch.float32)
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, layout=layout, edit=edit, timesteps=t)
...
__all__ = ["DiffusionSchedule", "ModelConfig", "CompactLayoutPreservingDiffusionModel", "q_sample"]
