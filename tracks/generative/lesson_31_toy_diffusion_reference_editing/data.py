...
def _make_toy_reference_editing_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class ToyReferenceEditingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._source, self._reference, self._target = _make_toy_reference_editing_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyReferenceEditingDataset(cfg)
...
__all__ = ["DataConfig", "ToyReferenceEditingDataset", "get_dataloaders"]
