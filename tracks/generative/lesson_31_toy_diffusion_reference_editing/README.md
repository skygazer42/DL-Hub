...
```bash
python -m tracks.generative.lesson_31_toy_diffusion_reference_editing.train --epochs 1 --device cpu
```

Artifacts are written to:

`outputs/generative/lesson_31_toy_diffusion_reference_editing/<run_name>/`
