...
class ToyDeblurringDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._blurry, self._sharp = _make_toy_deblurring_data(cfg)
...
def _make_toy_deblurring_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = ToyDeblurringDataset(cfg)
