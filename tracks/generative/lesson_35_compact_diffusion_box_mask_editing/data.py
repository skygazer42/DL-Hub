...
def _make_synthetic_box_mask_editing_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class SyntheticBoxMaskEditingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._source, self._box_mask, self._target = _make_synthetic_box_mask_editing_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = SyntheticBoxMaskEditingDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticBoxMaskEditingDataset", "get_dataloaders"]
