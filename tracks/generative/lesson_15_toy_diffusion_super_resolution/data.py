...
class ToySuperResolutionDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._low_res, self._high_res = _make_toy_super_resolution_data(cfg)
...
def _make_toy_super_resolution_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = ToySuperResolutionDataset(cfg)
