...
class CompactLayoutSubjectFusionDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        features = torch.cat([xt, layout, subject_style, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        subject_style = subject_style.to(device=device, dtype=torch.float32)
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, layout=layout, subject_style=subject_style, timesteps=t)
...
__all__ = ["DiffusionSchedule", "ModelConfig", "CompactLayoutSubjectFusionDiffusionModel", "q_sample"]
