...
```bash
python -m tracks.generative.lesson_36_compact_diffusion_layout_subject_fusion.train --epochs 1 --device cpu
```

## Outputs

`outputs/generative/lesson_36_compact_diffusion_layout_subject_fusion/<run_name>/`
