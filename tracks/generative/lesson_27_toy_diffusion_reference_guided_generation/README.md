# Lesson 27: Toy Diffusion Reference-Guided Generation
...
```bash
python -m tracks.generative.lesson_27_toy_diffusion_reference_guided_generation.train --device cpu --epochs 1
```
