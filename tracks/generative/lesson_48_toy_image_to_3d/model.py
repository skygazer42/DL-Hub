...
from dlhub.generative.image_to_3d import (
    ...
    build_zero123_toy_image_to_3d_generator,
)
...
class ModelConfig:
    in_channels: int = 3
    family: str = "zero123_toy"
    variant: str = "zero123_toy_tiny"
...
class ToyImageTo3DModel(nn.Module):
...
__all__ = ["ModelConfig", "ToyImageTo3DModel", "image_to_3d_loss"]
