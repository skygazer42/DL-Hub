...
class ToyImageEditDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._source, self._target, self._mask, self._control = _make_toy_edit_data(cfg)
...
def _make_toy_edit_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = ToyImageEditDataset(cfg)
