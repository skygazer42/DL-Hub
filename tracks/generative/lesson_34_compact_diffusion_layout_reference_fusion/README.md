...
```bash
python -m tracks.generative.lesson_34_compact_diffusion_layout_reference_fusion.train --epochs 1 --device cpu
```

## Outputs

`outputs/generative/lesson_34_compact_diffusion_layout_reference_fusion/<run_name>/`
