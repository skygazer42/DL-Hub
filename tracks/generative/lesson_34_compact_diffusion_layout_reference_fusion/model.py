...
class CompactLayoutReferenceFusionDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        features = torch.cat([xt, layout, reference, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, layout=layout, reference=reference, timesteps=t)
...
__all__ = ["DiffusionSchedule", "ModelConfig", "CompactLayoutReferenceFusionDiffusionModel", "q_sample"]
