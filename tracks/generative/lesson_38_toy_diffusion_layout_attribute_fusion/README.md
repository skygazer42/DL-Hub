# Lesson 38: Toy Diffusion Layout-Attribute Fusion
...
```bash
python -m tracks.generative.lesson_38_toy_diffusion_layout_attribute_fusion.train --epochs 1 --device cpu
```

Outputs are written under
`outputs/generative/lesson_38_toy_diffusion_layout_attribute_fusion/<run_name>/`.
