...
def _make_toy_subject_driven_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class ToySubjectDrivenDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._subject, self._guidance, self._target = _make_toy_subject_driven_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToySubjectDrivenDataset(cfg)
...
__all__ = ["DataConfig", "ToySubjectDrivenDataset", "get_dataloaders"]
