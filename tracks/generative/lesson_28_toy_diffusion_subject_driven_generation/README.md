...
```bash
python -m tracks.generative.lesson_28_toy_diffusion_subject_driven_generation.train --epochs 1 --device cpu
```

## Outputs

`outputs/generative/lesson_28_toy_diffusion_subject_driven_generation/<run_name>/`
