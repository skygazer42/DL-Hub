...
def parse_args() -> tuple[TrainConfig, DataConfig, ModelConfig, DiffusionSchedule]:
    parser = argparse.ArgumentParser(
        description=(
            "Lesson 24 (Generative): toy conditional diffusion image synthesis "
...
def _evaluate(
    model: ToyImageSynthesisDiffusionModel,
...
def run_training(
    ...
    paths = build_run_paths(
        track="generative",
        lesson="lesson_24_toy_diffusion_image_synthesis",
        run_name=train_cfg.run_name,
    )
    logger = get_logger("generative.toy_diffusion_image_synthesis", log_file=paths.logs_dir / "train.log")
    ...
    model = ToyImageSynthesisDiffusionModel(model_cfg).to(device_info.torch_device)
    ...
    ckpt_path = save_checkpoint(
        ...
        extra={"track": "generative", "lesson": "lesson_24_toy_diffusion_image_synthesis"},
    )
