...
def _make_toy_synthesis_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
class ToyImageSynthesisDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._condition, self._target = _make_toy_synthesis_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyImageSynthesisDataset(cfg)
...
__all__ = ["DataConfig", "ToyImageSynthesisDataset", "get_dataloaders"]
