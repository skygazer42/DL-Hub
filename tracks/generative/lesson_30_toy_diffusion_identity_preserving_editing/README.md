...
```bash
python -m tracks.generative.lesson_30_toy_diffusion_identity_preserving_editing.train --epochs 1 --device cpu
```

## Outputs

`outputs/generative/lesson_30_toy_diffusion_identity_preserving_editing/<run_name>/`
