...
def _make_toy_identity_preserving_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class ToyIdentityPreservingEditingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._subject, self._edit, self._target = _make_toy_identity_preserving_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyIdentityPreservingEditingDataset(cfg)
...
__all__ = ["DataConfig", "ToyIdentityPreservingEditingDataset", "get_dataloaders"]
