...
def _make_toy_layout_reference_fusion_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class ToyLayoutReferenceFusionDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._layout, self._reference, self._target = _make_toy_layout_reference_fusion_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyLayoutReferenceFusionDataset(cfg)
...
__all__ = ["DataConfig", "ToyLayoutReferenceFusionDataset", "get_dataloaders"]
