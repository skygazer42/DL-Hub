...
class CompactReflectionRemovalDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        features = torch.cat([xt, reflected, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        reflected = reflected.to(device=device, dtype=torch.float32)
        n = int(reflected.shape[0])
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, reflected=reflected, timesteps=t)
