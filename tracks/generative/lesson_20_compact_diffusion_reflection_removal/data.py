...
class SyntheticReflectionRemovalDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._reflected, self._clean = _make_synthetic_reflection_data(cfg)
...
def _make_synthetic_reflection_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = SyntheticReflectionRemovalDataset(cfg)
