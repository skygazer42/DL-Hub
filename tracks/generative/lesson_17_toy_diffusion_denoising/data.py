...
class ToyDenoisingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._noisy, self._clean = _make_toy_denoising_data(cfg)
...
def _make_toy_denoising_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = ToyDenoisingDataset(cfg)
