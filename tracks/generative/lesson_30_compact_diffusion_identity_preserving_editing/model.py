...
class CompactIdentityPreservingDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        features = torch.cat([xt, subject, edit, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, subject=subject, edit=edit, timesteps=t)
...
__all__ = ["DiffusionSchedule", "ModelConfig", "CompactIdentityPreservingDiffusionModel", "q_sample"]
