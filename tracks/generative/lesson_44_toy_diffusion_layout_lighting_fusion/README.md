...
```bash
python -m tracks.generative.lesson_44_toy_diffusion_layout_lighting_fusion.train --epochs 1 --device cpu
```

Outputs are written under
`outputs/generative/lesson_44_toy_diffusion_layout_lighting_fusion/<run_name>/`.
