...
class ToyDerainingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._rainy, self._clean = _make_toy_deraining_data(cfg)
...
def _make_toy_deraining_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = ToyDerainingDataset(cfg)
