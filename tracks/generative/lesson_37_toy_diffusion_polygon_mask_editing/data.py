...
def _make_toy_polygon_mask_editing_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class ToyPolygonMaskEditingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._source, self._polygon_mask, self._target = _make_toy_polygon_mask_editing_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyPolygonMaskEditingDataset(cfg)
...
__all__ = ["DataConfig", "ToyPolygonMaskEditingDataset", "get_dataloaders"]
