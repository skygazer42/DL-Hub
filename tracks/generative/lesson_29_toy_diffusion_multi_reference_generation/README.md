# Lesson 29: Toy Diffusion Multi-Reference Generation
...
```bash
python -m tracks.generative.lesson_29_toy_diffusion_multi_reference_generation.train --device cpu --epochs 1
```
