...
class ToyInpaintingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._context, self._target, self._mask = _make_toy_inpainting_data(cfg)
...
def _make_toy_inpainting_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = ToyInpaintingDataset(cfg)
