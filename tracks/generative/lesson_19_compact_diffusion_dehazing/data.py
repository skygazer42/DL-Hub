...
class SyntheticDehazingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._hazy, self._clean = _make_synthetic_dehazing_data(cfg)
...
def _make_synthetic_dehazing_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = SyntheticDehazingDataset(cfg)
