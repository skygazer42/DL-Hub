...
```bash
python -m tracks.generative.lesson_33_toy_diffusion_masked_reference_editing.train --epochs 1 --device cpu
```

Outputs land under
`outputs/generative/lesson_33_toy_diffusion_masked_reference_editing/<run_name>/`.
