...
```bash
python -m tracks.generative.lesson_32_toy_diffusion_layout_preserving_editing.train --epochs 1 --device cpu
```

## Outputs

`outputs/generative/lesson_32_toy_diffusion_layout_preserving_editing/<run_name>/`
