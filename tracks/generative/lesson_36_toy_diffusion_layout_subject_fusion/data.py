...
def _make_toy_layout_subject_fusion_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class ToyLayoutSubjectFusionDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._layout, self._subject_style, self._target = _make_toy_layout_subject_fusion_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyLayoutSubjectFusionDataset(cfg)
...
__all__ = ["DataConfig", "ToyLayoutSubjectFusionDataset", "get_dataloaders"]
