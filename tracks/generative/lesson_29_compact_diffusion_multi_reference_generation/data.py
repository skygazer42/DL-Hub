...
class SyntheticMultiReferenceGenerationDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._reference_a, self._reference_b, self._condition, self._target = _make_synthetic_multi_reference_data(cfg)
...
def _make_synthetic_multi_reference_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = SyntheticMultiReferenceGenerationDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticMultiReferenceGenerationDataset", "get_dataloaders"]
