...
class ToyControlNetDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._targets, self._structure_hints = _make_toy_controlnet_data(cfg)
...
def _make_toy_controlnet_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    ds: Dataset = ToyControlNetDataset(cfg)
