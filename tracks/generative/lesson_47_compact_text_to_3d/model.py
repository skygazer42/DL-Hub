...
class ModelConfig:
    in_channels: int = 3
    latent_dim: int = 64
    family: str = "dreamfusion_baseline"
    variant: str = "dreamfusion_baseline_tiny"
    width_mult: float = 1.0


_FAMILY_TO_BUILDER = {
    "dreamfusion_baseline": "build_dreamfusion_baseline_text3d_generator",
    "gaussian_text3d": "build_gaussian_text3d_text3d_generator",
    "magic3d_baseline": "build_magic3d_baseline_text3d_generator",
}
...
class CompactTextTo3DModel(nn.Module):
...
__all__ = ["ModelConfig", "CompactTextTo3DModel", "text_to_3d_loss"]
