# Lesson 41: Compact Diffusion Stroke-Mask Editing
...
```bash
python -m tracks.generative.lesson_41_compact_diffusion_stroke_mask_editing.train --epochs 1 --device cpu
```

Outputs are written to `outputs/generative/lesson_41_compact_diffusion_stroke_mask_editing/<run_name>/`.
