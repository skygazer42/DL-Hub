...
class ToyMultiFocusFusionDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._focus_a, self._focus_b, self._target = _make_toy_multi_focus_data(cfg)
...
def _make_toy_multi_focus_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyMultiFocusFusionDataset(cfg)
