...
```bash
python -m tracks.generative.lesson_42_toy_diffusion_layout_palette_fusion.train --epochs 1 --device cpu
```

Outputs are written under
`outputs/generative/lesson_42_toy_diffusion_layout_palette_fusion/<run_name>/`.
