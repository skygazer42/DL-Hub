...
def _make_toy_variation_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor]:
...
class ToyImageVariationDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._source, self._target = _make_toy_variation_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyImageVariationDataset(cfg)
...
__all__ = ["DataConfig", "ToyImageVariationDataset", "get_dataloaders"]
