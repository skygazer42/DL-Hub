...
class CompactImageFusionDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        features = torch.cat([xt, obs_a, obs_b, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        obs_a = obs_a.to(device=device, dtype=torch.float32)
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, obs_a=obs_a, obs_b=obs_b, timesteps=t)
