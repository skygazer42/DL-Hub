...
```bash
python -m tracks.generative.lesson_45_toy_video_diffusion.train --epochs 1 --device cpu
```

Outputs are written under `outputs/generative/lesson_45_toy_video_diffusion/<run_name>/`.
