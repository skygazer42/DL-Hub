...
def _make_synthetic_path_mask_editing_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class SyntheticPathMaskEditingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._source, self._path_mask, self._target = _make_synthetic_path_mask_editing_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = SyntheticPathMaskEditingDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticPathMaskEditingDataset", "get_dataloaders"]
