...
def _make_synthetic_masked_reference_editing_data(
    cfg: DataConfig,
...
class SyntheticMaskedReferenceEditingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._source, self._reference, self._mask, self._target = _make_synthetic_masked_reference_editing_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = SyntheticMaskedReferenceEditingDataset(cfg)
...
__all__ = ["DataConfig", "SyntheticMaskedReferenceEditingDataset", "get_dataloaders"]
