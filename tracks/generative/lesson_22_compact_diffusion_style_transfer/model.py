...
class CompactStyleTransferDiffusionModel(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        fused = torch.cat([xt, content, style, t_map], dim=1)
    ...
    def sample(
        ...
        *,
        ...
        content = content.to(device=device, dtype=torch.float32)
        ...
        for step in range(step_count - 1, -1, -1):
            ...
            pred_noise = self(xt=xt, content=content, style=style, timesteps=t)
...
__all__ = ["DiffusionSchedule", "ModelConfig", "CompactStyleTransferDiffusionModel", "q_sample"]
