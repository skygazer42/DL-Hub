...
def _make_toy_scribble_mask_editing_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class ToyScribbleMaskEditingDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._source, self._scribble_mask, self._target = _make_toy_scribble_mask_editing_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyScribbleMaskEditingDataset(cfg)
...
__all__ = ["DataConfig", "ToyScribbleMaskEditingDataset", "get_dataloaders"]
