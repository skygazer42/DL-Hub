# Lesson 39: Toy Diffusion Scribble-Mask Editing
...
```bash
python -m tracks.generative.lesson_39_toy_diffusion_scribble_mask_editing.train --epochs 1 --device cpu
```

Outputs land under `outputs/generative/lesson_39_toy_diffusion_scribble_mask_editing/<run_name>/`.
