...
def _make_toy_style_data(cfg: DataConfig) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
...
class ToyStyleTransferDataset(Dataset):
    def __init__(self, cfg: DataConfig) -> None:
        self.cfg = cfg
        self._content, self._style, self._target = _make_toy_style_data(cfg)
...
def get_dataloaders(cfg: DataConfig) -> tuple[DataLoader, DataLoader]:
    dataset: Dataset = ToyStyleTransferDataset(cfg)
...
__all__ = ["DataConfig", "ToyStyleTransferDataset", "get_dataloaders"]
