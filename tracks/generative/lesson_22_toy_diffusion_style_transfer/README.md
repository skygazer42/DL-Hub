# Lesson 22: Toy Diffusion Style Transfer
...
```bash
python -m tracks.generative.lesson_22_toy_diffusion_style_transfer.train --epochs 1 --num-samples 64 --batch-size 8 --max-train-batches 2 --max-eval-batches 1 --device cpu --run-name smoke
```

## Outputs

`outputs/generative/lesson_22_toy_diffusion_style_transfer/<run_name>/`
