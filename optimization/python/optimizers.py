...
class Momentum(Optimizer):
    def __init__(self, learning_rate: float, momentum: float = 0.9, weight_decay: float = 0.0) -> None:
        super().__init__(learning_rate)
...
class Adagrad(Optimizer):
    def __init__(self, learning_rate: float, epsilon: float = 1e-8, weight_decay: float = 0.0) -> None:
        super().__init__(learning_rate)
        self.epsilon = float(epsilon)
        self.weight_decay = float(weight_decay)
