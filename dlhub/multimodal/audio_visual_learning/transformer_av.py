...
_VARIANTS = {
    "transformer_av_tiny": {"width": 24, "depth": 1},
    "transformer_av_small": {"width": 32, "depth": 2},
    "transformer_av_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_audio_visual_model(build_transformer_av_audio_visual_model, "transformer_av_tiny")
