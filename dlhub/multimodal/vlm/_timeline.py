...
_ENTRIES: list[TimelineEntry] = [
    TimelineEntry(2021, "vilt", "ViLT (single-stream vision-language transformer)", "single_stream"),
    ...
    TimelineEntry(2021, "simvlm", "SimVLM (simple visual language model with prefix LM)", "fusion_encoder_decoder"),
    TimelineEntry(2021, "lit", "LiT (locked-image text tuning)", "dual_encoder"),
    TimelineEntry(2022, "ofa", "OFA (unified sequence-to-sequence multimodal model)", "fusion_encoder_decoder"),
    TimelineEntry(2022, "blip", "BLIP (bootstrapped language-image pretraining)", "fusion_encoder_decoder"),
    ...
    TimelineEntry(2023, "instructblip", "InstructBLIP (instruction-aware BLIP-2)", "multimodal_llm"),
    ...
    TimelineEntry(2023, "pali_x", "PaLI-X (multilingual transfer at scale)", "fusion_encoder_decoder"),
    TimelineEntry(2023, "minigpt4", "MiniGPT-4 (visual instruction alignment)", "multimodal_llm"),
    TimelineEntry(2023, "mplug_owl2", "mPLUG-Owl2 (modular multimodal chat model)", "multimodal_llm"),
