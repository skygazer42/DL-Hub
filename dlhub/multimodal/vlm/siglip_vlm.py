...
_VARIANTS: dict[str, dict[str, int]] = {
    "siglip_vlm_tiny": {"width": 88, "depth": 2, "embed": 64},
    "siglip_vlm_small": {"width": 128, "depth": 3, "embed": 96},
    "siglip_vlm_base": {"width": 168, "depth": 4, "embed": 128},
}


def build_siglip_vlm_vlm(
    *,
    image_size: int = 32,
    vocab_size: int = 128,
    seq_len: int = 16,
