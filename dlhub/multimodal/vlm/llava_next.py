...
_VARIANTS: dict[str, dict[str, int]] = {
    "llava_next_tiny": {"width": 88, "depth": 2, "embed": 64},
    "llava_next_small": {"width": 128, "depth": 3, "embed": 96},
    "llava_next_base": {"width": 168, "depth": 4, "embed": 128},
}


def build_llava_next_vlm(
    *,
    image_size: int = 32,
    vocab_size: int = 128,
    seq_len: int = 16,
