...
_VARIANTS: dict[str, dict[str, int]] = {
    "qwen2_vl_tiny": {"width": 88, "depth": 2, "embed": 64},
    "qwen2_vl_small": {"width": 128, "depth": 3, "embed": 96},
    "qwen2_vl_base": {"width": 168, "depth": 4, "embed": 128},
}


def build_qwen2_vl_vlm(
    *,
    image_size: int = 32,
    vocab_size: int = 128,
    seq_len: int = 16,
