...
_VARIANTS: dict[str, dict[str, int]] = {
    ...
    "olmocr_small": {"width": 128, "depth": 3, "embed": 96},
    "olmocr_base": {"width": 168, "depth": 4, "embed": 128},
}


def build_olmocr_vlm(
    *,
    image_size: int = 32,
    vocab_size: int = 128,
    seq_len: int = 16,
...
if __name__ == "__main__":
    smoke_test_vlm(build_olmocr_vlm, "olmocr_tiny")
