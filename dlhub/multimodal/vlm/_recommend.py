...
_PROFILES: dict[str, ProfileSpec] = {
    "balanced": ProfileSpec(
        ...
        preferred_families=("clip", "albef", "blip", "blip2", "llava"),
        modern_bias=0.2,
    ),
    "retrieval": ProfileSpec(
        ...
        preferred_families=("clip", "align", "albef", "vilt"),
    ...
    "captioning": ProfileSpec(
        ...
        preferred_families=("blip", "ofa", "coca", "flamingo", "blip2"),
        modern_bias=0.2,
    ),
    "instruction": ProfileSpec(
        ...
        preferred_families=("llava", "instructblip", "blip2", "kosmos2", "flamingo"),
        modern_bias=0.35,
    ),
    "lightweight": ProfileSpec(
        ...
        preferred_families=("vilt", "clip", "align", "albef", "blip"),
        discouraged_groups=("multimodal_llm",),
        modern_bias=0.05,
    ),
}
