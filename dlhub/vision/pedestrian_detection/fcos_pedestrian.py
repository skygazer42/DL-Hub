...
_VARIANTS: dict[str, dict[str, int]] = {
    "fcos_pedestrian_tiny": {"width": 24, "depth": 1, "queries": 24},
    "fcos_pedestrian_small": {"width": 36, "depth": 2, "queries": 32},
    "fcos_pedestrian_base": {"width": 48, "depth": 3, "queries": 48},
}
...
if __name__ == "__main__":
    smoke_test_pedestrian_detector(
        build_fcos_pedestrian_pedestrian_detector, "fcos_pedestrian_tiny"
    )
