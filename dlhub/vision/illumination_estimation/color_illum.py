...
_VARIANTS: dict[str, dict[str, int]] = {
    "color_illum_tiny": {"width": 24, "depth": 1},
    "color_illum_small": {"width": 36, "depth": 2},
    "color_illum_base": {"width": 48, "depth": 3},
}


def build_color_illum_illumination_estimator(
    *, in_channels: int, variant: str = "color_illum_small", width_mult: float = 1.0
) -> nn.Module:
