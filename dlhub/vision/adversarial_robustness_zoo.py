...
def _split_arch_id(arch_id: str) -> tuple[str, str]:
    ...
    return split_arch_id(arch_id, default_prefix="advrob")
...
def _registry() -> dict[str, Builder]:
    ...
    return make_lazy_family_registry(
        _FAMILIES,
        _SIZES,
        module_template="dlhub.vision.adversarial_robustness.{family}",
        builder_template="build_{family}_robust_model",
...
def list_local_arches() -> list[str]:
    ...
    return list_arch_ids(_REGISTRY, prefix="advrob")
