...
_VARIANTS: dict[str, dict[str, int]] = {
    "transformer_handedness_tiny": {"width": 24, "depth": 1, "num_classes": 2},
    "transformer_handedness_small": {"width": 36, "depth": 2, "num_classes": 2},
    "transformer_handedness_base": {"width": 48, "depth": 3, "num_classes": 2},
}
...
if __name__ == "__main__":
    smoke_test_hand_classifier(
        build_transformer_handedness_handedness_classifier, "transformer_handedness_tiny"
    )
