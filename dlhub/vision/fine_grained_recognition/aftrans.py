...
class AFTrans(TransformerFGVCModel):
    def __init__(self, *, family: str = "aftrans", **kwargs) -> None:
        super().__init__(family=family, **kwargs)


_VARIANTS: dict[str, dict[str, int]] = make_fgvc_variants("aftrans", group="transformer")
...
if __name__ == "__main__":
    smoke_test_classifier(build_aftrans_fgvc_classifier, "aftrans_tiny")
