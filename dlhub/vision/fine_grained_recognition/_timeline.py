...
_ENTRIES: list[TimelineEntry] = [
    ...
    TimelineEntry(2018, "isqrt_cov", "iSQRT-COV (iterative matrix sqrt for covariance pooling)", "bilinear"),
    ...
    TimelineEntry(2022, "metaformer_fgvc", "MetaFormer (backbone-style transformer family)", "transformer"),
    ...
    TimelineEntry(2025, "prompt_cam", "Prompt-CAM (interpretable prompt attention map)", "transformer"),
    TimelineEntry(2025, "fg_clip", "FG-CLIP (CLIP-style visual-text alignment)", "transformer"),
    TimelineEntry(2025, "finer_cam", "Finer-CAM (difference spotting for explanation)", "transformer"),
    TimelineEntry(2025, "xr_vlm", "XR-VLM (multi-part prompts + cross-relationship modeling)", "transformer"),
    TimelineEntry(2025, "gft", "GFT (graph-guided fine-tuning transformer)", "transformer"),
    TimelineEntry(2025, "e_finer", "E-FineR (efficient vocabulary-free FGVC with enriched grounding)", "transformer"),
    TimelineEntry(2025, "unifgvc", "UniFGVC (universal fine-grained category discovery)", "transformer"),
    TimelineEntry(2025, "granvit", "GranViT (hierarchical granularity-aware vision transformer)", "transformer"),
    TimelineEntry(2025, "saccadic_vision", "Saccadic Vision (glimpse-based adaptive FGVC)", "part"),
    TimelineEntry(2025, "causal_fsfg", "CausalFSFG (causal few-shot fine-grained recognition)", "relation"),
    TimelineEntry(2025, "micro_clip", "MicroCLIP (small CLIP-style FGVC adaptation)", "transformer"),
    TimelineEntry(2025, "dcnn_fg", "DCNN-FG (dual-cross current network for FGVC)", "relation"),
    TimelineEntry(2025, "hfcr_net", "HFCR-Net (hierarchical feature calibration and relation learning)", "relation"),
    TimelineEntry(2025, "cmcp_meta", "CMCP-Meta (connecting meta via cross-contrastive pretraining)", "relation"),
    TimelineEntry(2025, "ficnet", "FICNet (fine-grained instance-centric compositional network)", "part"),
    ...
    TimelineEntry(2025, "pp_ssl", "PP-SSL (part-prototype self-supervised learning for few-shot FGVC)", "part"),
    TimelineEntry(2025, "part_rel_transformer", "PART (part-guided relational transformer for FGVC)", "relation"),
    TimelineEntry(2025, "highorder_graph", "HighOrderGraph (graph-based high-order relation discovery for FGVC)", "relation"),
    TimelineEntry(2025, "part_matching", "Part Matching (few-shot FGVC with explicit part matching)", "part"),
    TimelineEntry(2025, "saliency_partition", "Saliency Partition (counterfactual salient-part reasoning for FGVC)", "relation"),
    TimelineEntry(2025, "late_fusion_transformer", "Late Fusion Transformer (multi-view / multi-cue FGVC fusion)", "transformer"),
    TimelineEntry(2026, "img_cot", "ImgCoT (compact visual CoT tokens)", "transformer"),
    TimelineEntry(2026, "refine_rft", "ReFine-RFT (reasoning length regulation / cost of thinking)", "transformer"),
    ...
    TimelineEntry(2026, "r2i_distill", "Zooming without Zooming (region-to-image distillation)", "transformer"),
]
