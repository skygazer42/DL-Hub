...
_VARIANTS: dict[str, dict[str, int]] = make_fgvc_variants("clippart_fgvc", group="transformer")


def build_clippart_fgvc_fgvc_classifier(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "clippart_fgvc_small",
    image_size: int = 64,
