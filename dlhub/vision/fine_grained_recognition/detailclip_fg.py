...
_VARIANTS: dict[str, dict[str, int]] = make_fgvc_variants("detailclip_fg", group="transformer")


def build_detailclip_fg_fgvc_classifier(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "detailclip_fg_small",
    image_size: int = 64,
