...
_VARIANTS: dict[str, dict[str, int]] = make_fgvc_variants("partclip_fgvc2", group="transformer")


def build_partclip_fgvc2_fgvc_classifier(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "partclip_fgvc2_small",
    image_size: int = 64,
    ...
    return build_fgvc_model(
        ...
        dropout=dropout,
        family="partclip_fgvc2",
    )


if __name__ == "__main__":
    smoke_test_classifier(build_partclip_fgvc2_fgvc_classifier, "partclip_fgvc2_tiny")
