...
class PEDTrans(TransformerFGVCModel):
    def __init__(self, *, family: str = "pedtrans", **kwargs) -> None:
        super().__init__(family=family, **kwargs)


_VARIANTS: dict[str, dict[str, int]] = make_fgvc_variants("pedtrans", group="transformer")
...
if __name__ == "__main__":
    smoke_test_classifier(build_pedtrans_fgvc_classifier, "pedtrans_tiny")
