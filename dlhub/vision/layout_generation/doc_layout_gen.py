...
def build_doc_layout_gen_layout_generator(*, in_channels: int, variant: str = 'doc_layout_gen_small', width_mult: float = 1.0):
...
if __name__ == '__main__':
    smoke_test_direction(build_doc_layout_gen_layout_generator, 'doc_layout_gen_tiny')
