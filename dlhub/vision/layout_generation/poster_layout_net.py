...
def build_poster_layout_net_layout_generator(*, in_channels: int, variant: str = 'poster_layout_net_small', width_mult: float = 1.0):
...
if __name__ == '__main__':
    smoke_test_direction(build_poster_layout_net_layout_generator, 'poster_layout_net_tiny')
