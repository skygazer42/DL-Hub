...
_VARIANTS: dict[str, dict[str, int]] = {
    "cnn_finger_count_tiny": {"width": 24, "depth": 1, "num_classes": 6},
    "cnn_finger_count_small": {"width": 36, "depth": 2, "num_classes": 6},
    "cnn_finger_count_base": {"width": 48, "depth": 3, "num_classes": 6},
}
...
if __name__ == "__main__":
    smoke_test_hand_classifier(
        build_cnn_finger_count_finger_count_estimator, "cnn_finger_count_tiny"
    )
