...
class ShufflemixerSR(nn.Module):
...
_VARIANTS: dict[str, dict[str, int]] = _default_variants("shufflemixer_sr")


def build_shufflemixer_sr_super_resolver(
    *,
    in_channels: int,
    variant: str = "shufflemixer_sr_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_shufflemixer_sr_super_resolver(in_channels=3, variant="shufflemixer_sr_tiny")
