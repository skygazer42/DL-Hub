...
_VARIANTS: dict[str, dict[str, int]] = {'transformer_salbox_tiny': {'width': 24, 'depth': 1, 'queries': 8}, 'transformer_salbox_small': {'width': 36, 'depth': 2, 'queries': 12}, 'transformer_salbox_base': {'width': 48, 'depth': 3, 'queries': 16}}
