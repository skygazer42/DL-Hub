...
_VARIANTS: dict[str, dict[str, int]] = {
    "proto_yolact_seg_tiny": {"width": 24, "depth": 1, "queries": 12, "protos": 6},
    "proto_yolact_seg_small": {"width": 36, "depth": 2, "queries": 16, "protos": 8},
    "proto_yolact_seg_base": {"width": 48, "depth": 3, "queries": 20, "protos": 10},
}
...
if __name__ == "__main__":
    smoke_test_instance_segmentor(
        build_proto_yolact_seg_instance_segmentor, "proto_yolact_seg_tiny"
    )
