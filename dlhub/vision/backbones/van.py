...
if __name__ == '__main__':
    ...
    m = build_van_classifier(in_channels=3, num_classes=10, variant='tiny', width_mult=1.0)
    y = m(x)
    print('van', tuple(y.shape))
