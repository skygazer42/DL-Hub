...
if __name__ == "__main__":
    ...
    m = build_crossvit_classifier(in_channels=3, num_classes=10, variant="tiny")
    y = m(x)
    if isinstance(y, tuple):
        print("crossvit", tuple(y[0].shape), tuple(y[1].shape))
    else:
        print("crossvit", tuple(y.shape))
