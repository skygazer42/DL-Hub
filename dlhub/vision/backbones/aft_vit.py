    ...
    def __init__(
        ...
        *,
        ...
        self.blocks = nn.Sequential(
            *[AFTBlock(int(dim), drop_path=float(dp_rates[i])) for i in range(int(depth))]
        )
...
if __name__ == "__main__":
    ...
    m = build_aft_vit_classifier(
        in_channels=3, num_classes=10, variant="aft_vit_tiny", image_size=64
    )
    y = m(x)
