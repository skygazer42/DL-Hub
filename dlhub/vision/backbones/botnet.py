...
if __name__ == '__main__':
    ...
    m = build_botnet_classifier(in_channels=3, num_classes=10, variant='tiny', width_mult=1.0)
    y = m(x)
    print('botnet', tuple(y.shape))
