...
class CaitClassifier(nn.Module):
    def __init__(
        self,
        *,
        in_channels: int,
...
if __name__ == "__main__":
    ...
    m = build_cait_classifier(in_channels=3, num_classes=10, variant="tiny")
    y = m(x)
    if isinstance(y, tuple):
        print("cait", tuple(y[0].shape), tuple(y[1].shape))
    else:
        print("cait", tuple(y.shape))
