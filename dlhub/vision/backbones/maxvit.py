...
if __name__ == "__main__":
    ...
    m = build_maxvit_classifier(in_channels=3, num_classes=10, variant="tiny")
    y = m(x)
    if isinstance(y, tuple):
        print("maxvit", tuple(y[0].shape), tuple(y[1].shape))
    else:
        print("maxvit", tuple(y.shape))
