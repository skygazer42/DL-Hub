...
if __name__ == "__main__":
    ...
    m = build_beit_classifier(in_channels=3, num_classes=10, variant="tiny")
    y = m(x)
    if isinstance(y, tuple):
        print("beit", tuple(y[0].shape), tuple(y[1].shape))
    else:
        print("beit", tuple(y.shape))
