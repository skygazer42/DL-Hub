...
class LevitClassifier(nn.Module):
    def __init__(
        self,
        *,
        in_channels: int,
...
if __name__ == "__main__":
    ...
    m = build_levit_classifier(in_channels=3, num_classes=10, variant="tiny")
    y = m(x)
    if isinstance(y, tuple):
        print("levit", tuple(y[0].shape), tuple(y[1].shape))
    else:
        print("levit", tuple(y.shape))
