...
class FractalnetClassifier(nn.Module):
    def __init__(
        self,
        *,
        in_channels: int,
...
def build_fractalnet_classifier(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "tiny",
...
if __name__ == "__main__":
    ...
    m = build_fractalnet_classifier(in_channels=3, num_classes=10, variant="tiny", width_mult=1.0)
    y = m(x)
    print("fractalnet", tuple(y.shape))
