...
class HalonetClassifier(nn.Module):
    def __init__(
        self,
        *,
        in_channels: int,
...
if __name__ == "__main__":
    ...
    m = build_halonet_classifier(in_channels=3, num_classes=10, variant="tiny", width_mult=1.0)
    y = m(x)
    print("halonet", tuple(y.shape))
