...
class ShufflenetV2plusClassifier(nn.Module):
    def __init__(
        self,
        *,
        in_channels: int,
...
def build_shufflenet_v2plus_classifier(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = 'tiny',
    ...
    return ShufflenetV2plusClassifier(
...
if __name__ == '__main__':
    ...
    m = build_shufflenet_v2plus_classifier(in_channels=3, num_classes=10, variant='tiny', width_mult=1.0)
    y = m(x)
    print('shufflenet_v2plus', tuple(y.shape))
