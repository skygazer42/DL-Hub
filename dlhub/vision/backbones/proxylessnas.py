...
class ProxylessnasClassifier(nn.Module):
    def __init__(
        self,
        *,
        in_channels: int,
...
def build_proxylessnas_classifier(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = 'tiny',
...
if __name__ == '__main__':
    ...
    m = build_proxylessnas_classifier(in_channels=3, num_classes=10, variant='tiny')
    y = m(x)
    print('proxylessnas', tuple(y.shape))
