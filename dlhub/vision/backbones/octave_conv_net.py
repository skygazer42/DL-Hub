...
class OctaveConvNetClassifier(nn.Module):
    def __init__(
        self,
        *,
        in_channels: int,
...
def build_octave_conv_net_classifier(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = 'tiny',
    ...
    return OctaveConvNetClassifier(
...
if __name__ == '__main__':
    ...
    m = build_octave_conv_net_classifier(in_channels=3, num_classes=10, variant='tiny', width_mult=1.0)
    y = m(x)
    print('octave_conv_net', tuple(y.shape))
