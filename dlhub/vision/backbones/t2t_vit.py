...
class T2tVitClassifier(nn.Module):
    def __init__(
        self,
        *,
        in_channels: int,
...
if __name__ == "__main__":
    ...
    m = build_t2t_vit_classifier(in_channels=3, num_classes=10, variant="tiny")
    y = m(x)
    if isinstance(y, tuple):
        print("t2t_vit", tuple(y[0].shape), tuple(y[1].shape))
    else:
        print("t2t_vit", tuple(y.shape))
