...
_VARIANTS: dict[str, dict[str, int]] = {
    "mamba_siseg_tiny": {"width": 24, "depth": 1, "queries": 8, "protos": 6},
    "mamba_siseg_small": {"width": 36, "depth": 2, "queries": 12, "protos": 8},
    "mamba_siseg_base": {"width": 48, "depth": 3, "queries": 16, "protos": 10},
}
...
if __name__ == "__main__":
    smoke_test_salient_instance_segmentor(
        build_mamba_siseg_salient_instance_segmentor, "mamba_siseg_tiny"
    )
