...
_FAMILIES = [
    "cnn_face_liveness",
    "artifact_face_liveness",
    "patch_face_liveness",
    "region_face_liveness",
    "transformer_face_liveness",
    "prompt_face_liveness",
    "contrastive_face_liveness",
    "graph_face_liveness",
    "dual_face_liveness",
    "mamba_face_liveness",
]
...
def _split_arch_id(arch_id: str) -> tuple[str, str]:
    ...
    return split_arch_id(arch_id, default_prefix="facelive")
...
def _registry() -> dict[str, Builder]:
    ...
    return make_lazy_family_registry(
        _FAMILIES,
        _SIZES,
        module_template="dlhub.vision.face_liveness_detection.{family}",
        builder_template="build_{family}_liveness_detector",
...
def list_local_arches() -> list[str]:
    ...
    return list_arch_ids(_REGISTRY, prefix="facelive")
