...
_VARIANTS: dict[str, dict[str, int]] = {
    "correlation_homography_tiny": {"width": 24, "depth": 1},
    "correlation_homography_small": {"width": 36, "depth": 2},
    "correlation_homography_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_homography_estimator(
        build_correlation_homography_homography_estimator, "correlation_homography_tiny"
    )
