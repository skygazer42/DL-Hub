...
_VARIANTS: dict[str, dict[str, int]] = {'prompt_faceid_tiny': {'width': 24, 'depth': 1, 'embedding_dim': 48}, 'prompt_faceid_small': {'width': 36, 'depth': 2, 'embedding_dim': 64}, 'prompt_faceid_base': {'width': 48, 'depth': 3, 'embedding_dim': 96}}
