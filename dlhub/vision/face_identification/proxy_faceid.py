...
_VARIANTS: dict[str, dict[str, int]] = {'proxy_faceid_tiny': {'width': 24, 'depth': 1, 'embedding_dim': 48}, 'proxy_faceid_small': {'width': 36, 'depth': 2, 'embedding_dim': 64}, 'proxy_faceid_base': {'width': 48, 'depth': 3, 'embedding_dim': 96}}
