...
_VARIANTS: dict[str, dict[str, int]] = {
    "bot_sort_tiny": {"width": 64, "num_tracks": 32},
    "bot_sort_small": {"width": 96, "num_tracks": 48},
    "bot_sort_base": {"width": 128, "num_tracks": 64},
}
...
def build_bot_sort_tracker(
    *,
    ...
    if cfg is None:
        raise ValueError(
            f"Unknown variant for bot_sort: {variant!r}. Available: {sorted(_VARIANTS)}"
        )
...
if __name__ == "__main__":
    smoke_test_tracker(build_bot_sort_tracker, "bot_sort_tiny")
