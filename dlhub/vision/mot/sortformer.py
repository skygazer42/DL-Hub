...
_VARIANTS: dict[str, dict[str, int]] = {
    "sortformer_tiny": {"width": 64, "num_tracks": 24},
    "sortformer_small": {"width": 96, "num_tracks": 36},
    "sortformer_base": {"width": 128, "num_tracks": 48},
}


def build_sortformer_tracker(
    *,
    in_channels: int,
    num_classes: int,
    seq_len: int = 4,
    image_size: int = 64,
    variant: str = "sortformer_tiny",
...
if __name__ == "__main__":
    smoke_test_tracker(build_sortformer_tracker, "sortformer_tiny")
