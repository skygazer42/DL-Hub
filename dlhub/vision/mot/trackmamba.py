...
_VARIANTS: dict[str, dict[str, int]] = {
    "trackmamba_tiny": {"width": 64, "num_tracks": 32},
    "trackmamba_small": {"width": 96, "num_tracks": 48},
    "trackmamba_base": {"width": 128, "num_tracks": 64},
}
...
def build_trackmamba_tracker(
    *,
    ...
    if cfg is None:
        raise ValueError(f"Unknown variant for trackmamba: {variant!r}. Available: {sorted(_VARIANTS)}")
