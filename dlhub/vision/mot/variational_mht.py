...
_VARIANTS: dict[str, dict[str, int]] = {
    "variational_mht_tiny": {"width": 64, "num_tracks": 32},
    "variational_mht_small": {"width": 96, "num_tracks": 48},
    "variational_mht_base": {"width": 128, "num_tracks": 64},
}


def build_variational_mht_tracker(
    *,
    in_channels: int,
    num_classes: int,
    seq_len: int = 4,
    image_size: int = 64,
    variant: str = "variational_mht_tiny",
...
if __name__ == "__main__":
    smoke_test_tracker(build_variational_mht_tracker, "variational_mht_tiny")
