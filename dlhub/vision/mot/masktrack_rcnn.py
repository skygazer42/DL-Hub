...
_VARIANTS: dict[str, dict[str, int]] = {
    "masktrack_rcnn_tiny": {"width": 64, "num_tracks": 32},
    "masktrack_rcnn_small": {"width": 96, "num_tracks": 48},
    "masktrack_rcnn_base": {"width": 128, "num_tracks": 64},
}


def build_masktrack_rcnn_tracker(
    *,
    in_channels: int,
    num_classes: int,
    seq_len: int = 4,
    image_size: int = 64,
    variant: str = "masktrack_rcnn_tiny",
...
if __name__ == "__main__":
    smoke_test_tracker(build_masktrack_rcnn_tracker, "masktrack_rcnn_tiny")
