...
_VARIANTS: dict[str, dict[str, int]] = {
    "v_iou_tiny": {"width": 64, "num_tracks": 32},
    "v_iou_small": {"width": 96, "num_tracks": 48},
    "v_iou_base": {"width": 128, "num_tracks": 64},
}


def build_v_iou_tracker(
    *,
    in_channels: int,
    num_classes: int,
    seq_len: int = 4,
    image_size: int = 64,
    variant: str = "v_iou_tiny",
...
if __name__ == "__main__":
    smoke_test_tracker(build_v_iou_tracker, "v_iou_tiny")
