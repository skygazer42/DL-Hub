...
_VARIANTS: dict[str, dict[str, int]] = {
    "motdt_tiny": {"width": 64, "num_tracks": 32},
    "motdt_small": {"width": 96, "num_tracks": 48},
    "motdt_base": {"width": 128, "num_tracks": 64},
}


def build_motdt_tracker(
    *,
    in_channels: int,
    num_classes: int,
    seq_len: int = 4,
    image_size: int = 64,
    variant: str = "motdt_tiny",
...
if __name__ == "__main__":
    smoke_test_tracker(build_motdt_tracker, "motdt_tiny")
