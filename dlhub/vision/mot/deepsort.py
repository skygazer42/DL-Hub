...
_VARIANTS: dict[str, dict[str, int]] = {
    "deepsort_tiny": {"width": 64, "num_tracks": 32},
    "deepsort_small": {"width": 96, "num_tracks": 48},
    "deepsort_base": {"width": 128, "num_tracks": 64},
}
...
def build_deepsort_tracker(
    *,
    ...
    if cfg is None:
        raise ValueError(
            f"Unknown variant for deepsort: {variant!r}. Available: {sorted(_VARIANTS)}"
        )
...
if __name__ == "__main__":
    smoke_test_tracker(build_deepsort_tracker, "deepsort_tiny")
