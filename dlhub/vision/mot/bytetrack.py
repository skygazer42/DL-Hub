...
_VARIANTS: dict[str, dict[str, int]] = {
    "bytetrack_tiny": {"width": 64, "num_tracks": 32},
    "bytetrack_small": {"width": 96, "num_tracks": 48},
    "bytetrack_base": {"width": 128, "num_tracks": 64},
}
...
def build_bytetrack_tracker(
    *,
    ...
    if cfg is None:
        raise ValueError(
            f"Unknown variant for bytetrack: {variant!r}. Available: {sorted(_VARIANTS)}"
        )
...
if __name__ == "__main__":
    smoke_test_tracker(build_bytetrack_tracker, "bytetrack_tiny")
