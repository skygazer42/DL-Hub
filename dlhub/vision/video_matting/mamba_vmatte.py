...
_VARIANTS = {"mamba_vmatte_tiny": {"width": 24, "depth": 1}, "mamba_vmatte_small": {"width": 32, "depth": 2}, "mamba_vmatte_base": {"width": 48, "depth": 3}}


def build_mamba_vmatte_video_matter(*, in_channels: int, variant: str = "mamba_vmatte_small", width_mult: float = 1.0):
