...
_VARIANTS = {"prompt_vmatte_tiny": {"width": 24, "depth": 1}, "prompt_vmatte_small": {"width": 32, "depth": 2}, "prompt_vmatte_base": {"width": 48, "depth": 3}}


def build_prompt_vmatte_video_matter(*, in_channels: int, variant: str = "prompt_vmatte_small", width_mult: float = 1.0):
