...
_VARIANTS = {"tcvomatting_tiny": {"width": 24, "depth": 1}, "tcvomatting_small": {"width": 32, "depth": 2}, "tcvomatting_base": {"width": 48, "depth": 3}}


def build_tcvomatting_video_matter(*, in_channels: int, variant: str = "tcvomatting_small", width_mult: float = 1.0):
