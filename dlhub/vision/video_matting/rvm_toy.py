...
_VARIANTS = {"rvm_toy_tiny": {"width": 24, "depth": 1}, "rvm_toy_small": {"width": 32, "depth": 2}, "rvm_toy_base": {"width": 48, "depth": 3}}


def build_rvm_toy_video_matter(*, in_channels: int, variant: str = "rvm_toy_small", width_mult: float = 1.0):
