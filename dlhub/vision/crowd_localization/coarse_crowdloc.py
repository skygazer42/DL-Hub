...
_VARIANTS: dict[str, dict[str, int]] = {
    "coarse_crowdloc_tiny": {"width": 24, "depth": 1, "num_points": 6},
    "coarse_crowdloc_small": {"width": 36, "depth": 2, "num_points": 8},
    "coarse_crowdloc_base": {"width": 48, "depth": 3, "num_points": 10},
}
