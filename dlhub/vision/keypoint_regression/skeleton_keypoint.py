...
_VARIANTS: dict[str, dict[str, int]] = {'skeleton_keypoint_tiny': {'width': 24, 'depth': 1, 'num_points': 8}, 'skeleton_keypoint_small': {'width': 36, 'depth': 2, 'num_points': 8}, 'skeleton_keypoint_base': {'width': 48, 'depth': 3, 'num_points': 8}}
