...
_VARIANTS: dict[str, dict[str, int]] = {
    "region_gesture_tiny": {"width": 24, "depth": 1, "num_classes": 4},
    "region_gesture_small": {"width": 36, "depth": 2, "num_classes": 4},
    "region_gesture_base": {"width": 48, "depth": 3, "num_classes": 4},
}
