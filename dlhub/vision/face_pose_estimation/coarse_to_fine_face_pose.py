...
_VARIANTS: dict[str, dict[str, int]] = {
    "coarse_to_fine_face_pose_tiny": {"width": 24, "depth": 1},
    "coarse_to_fine_face_pose_small": {"width": 36, "depth": 2},
    "coarse_to_fine_face_pose_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_face_pose_estimator(
        build_coarse_to_fine_face_pose_face_pose_estimator, "coarse_to_fine_face_pose_tiny"
    )
