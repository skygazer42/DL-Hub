...
def build_cutmix_aug_augmenter(*, in_channels:int, variant:str='cutmix_aug_small', width_mult:float=1.0):
    return build_toy_augmenter(family='cutmix_aug', variants=_VARIANTS, in_channels=int(in_channels), variant=str(variant), width_mult=float(width_mult))
if __name__ == '__main__': smoke_test_augmenter(build_cutmix_aug_augmenter, 'cutmix_aug_tiny')
