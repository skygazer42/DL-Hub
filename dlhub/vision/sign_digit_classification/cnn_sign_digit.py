...
_VARIANTS: dict[str, dict[str, int]] = {'cnn_sign_digit_tiny': {'width': 24, 'depth': 1, 'num_classes': 10}, 'cnn_sign_digit_small': {'width': 36, 'depth': 2, 'num_classes': 10}, 'cnn_sign_digit_base': {'width': 48, 'depth': 3, 'num_classes': 10}}
