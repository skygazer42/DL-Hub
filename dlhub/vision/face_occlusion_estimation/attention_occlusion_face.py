...
_VARIANTS: dict[str, dict[str, int]] = {
    "attention_occlusion_face_tiny": {"width": 24, "depth": 1},
    "attention_occlusion_face_small": {"width": 36, "depth": 2},
    "attention_occlusion_face_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_face_occlusion_estimator(
        build_attention_occlusion_face_occlusion_estimator, "attention_occlusion_face_tiny"
    )
