...
_VARIANTS: dict[str, dict[str, int]] = {
    "patch_occlusion_face_tiny": {"width": 24, "depth": 1},
    "patch_occlusion_face_small": {"width": 36, "depth": 2},
    "patch_occlusion_face_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_face_occlusion_estimator(
        build_patch_occlusion_face_occlusion_estimator, "patch_occlusion_face_tiny"
    )
