...
_VARIANTS: dict[str, dict[str, int]] = {
    "transformer_road_scene_tiny": {"width": 24, "depth": 1},
    "transformer_road_scene_small": {"width": 36, "depth": 2},
    "transformer_road_scene_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_road_scene_model(
        build_transformer_road_scene_road_scene_model, "transformer_road_scene_tiny"
    )
