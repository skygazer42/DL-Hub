...
_VARIANTS: dict[str, dict[str, int]] = {'scene_fusion_road_tiny': {'width': 24, 'depth': 1}, 'scene_fusion_road_small': {'width': 36, 'depth': 2}, 'scene_fusion_road_base': {'width': 48, 'depth': 3}}
