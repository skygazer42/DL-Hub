...
def smoke_test_model(builder, variant:str): out=builder(in_channels=3, variant=variant, width_mult=0.5, num_classes=20)(torch.randn(2,3,96,96)); print(variant, tuple(out['logits'].shape))
