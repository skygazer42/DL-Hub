...
_VARIANTS: dict[str, dict[str, int]] = {'contrastive_verify_tiny': {'width': 24, 'embedding_dim': 48}, 'contrastive_verify_small': {'width': 36, 'embedding_dim': 64}, 'contrastive_verify_base': {'width': 48, 'embedding_dim': 96}}
