...
_VARIANTS: dict[str, dict[str, int]] = {'prompt_verify_tiny': {'width': 24, 'embedding_dim': 48}, 'prompt_verify_small': {'width': 36, 'embedding_dim': 64}, 'prompt_verify_base': {'width': 48, 'embedding_dim': 96}}
