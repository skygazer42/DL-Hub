...
_VARIANTS: dict[str, dict[str, int]] = {'arcface_verify_tiny': {'width': 24, 'embedding_dim': 48}, 'arcface_verify_small': {'width': 36, 'embedding_dim': 64}, 'arcface_verify_base': {'width': 48, 'embedding_dim': 96}}
