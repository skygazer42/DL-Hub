...
_VARIANTS: dict[str, dict[str, int]] = {'relation_verify_tiny': {'width': 24, 'embedding_dim': 48}, 'relation_verify_small': {'width': 36, 'embedding_dim': 64}, 'relation_verify_base': {'width': 48, 'embedding_dim': 96}}
