...
_VARIANTS: dict[str, dict[str, int]] = {'occlusion_verify_tiny': {'width': 24, 'embedding_dim': 48}, 'occlusion_verify_small': {'width': 36, 'embedding_dim': 64}, 'occlusion_verify_base': {'width': 48, 'embedding_dim': 96}}
