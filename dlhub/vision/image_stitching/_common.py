...
def smoke_test_model(builder, variant: str):
    ...
    out = builder(in_channels=3, variant=variant, width_mult=0.5)(x1, x2)
    print(variant, tuple(out["offsets"].shape))
