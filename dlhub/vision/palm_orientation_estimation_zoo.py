...
_FAMILIES = [
    "direct_palm_orientation",
    "heatmap_palm_orientation",
    "graph_palm_orientation",
    "transformer_palm_orientation",
    "prompt_palm_orientation",
    "coarse_to_fine_palm_orientation",
    "multiview_palm_orientation",
    "region_palm_orientation",
    "uncertainty_palm_orientation",
    "mamba_palm_orientation",
]
...
def _split_arch_id(arch_id: str) -> tuple[str, str]:
    ...
    return split_arch_id(arch_id, default_prefix="palmori")
...
def _registry() -> dict[str, Builder]:
    ...
    return make_lazy_family_registry(
        _FAMILIES,
        _SIZES,
        module_template="dlhub.vision.palm_orientation_estimation.{family}",
        builder_template="build_{family}_palm_orientation_estimator",
...
def list_local_arches() -> list[str]:
    ...
    return list_arch_ids(_REGISTRY, prefix="palmori")
