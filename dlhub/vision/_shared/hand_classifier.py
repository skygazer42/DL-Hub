...
class TinyHandClassifier(nn.Module):
    def __init__(
        self, *, family: str, mode: str, in_channels: int, width: int, depth: int, num_classes: int
    ) -> None:
        super().__init__()
        ...
        self.blocks = nn.ModuleList(
            [
                TinyHandClassifierBlock(channels=int(width), mode=str(mode))
