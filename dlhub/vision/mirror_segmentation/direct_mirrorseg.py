...
_VARIANTS: dict[str, dict[str, int]] = {
    "direct_mirrorseg_tiny": {"width": 24, "depth": 1},
    "direct_mirrorseg_small": {"width": 36, "depth": 2},
    "direct_mirrorseg_base": {"width": 48, "depth": 3},
}


def build_direct_mirrorseg_mirror_segmentor(
    *, in_channels: int, variant: str = "direct_mirrorseg_small", width_mult: float = 1.0
) -> nn.Module:
