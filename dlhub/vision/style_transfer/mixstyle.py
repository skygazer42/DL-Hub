...
_VARIANTS: dict[str, dict[str, int]] = {
    "mixstyle_tiny": {"width": 24, "depth": 2},
    "mixstyle_small": {"width": 32, "depth": 3},
    "mixstyle_base": {"width": 48, "depth": 4},
}
...
class MixstyleStyleTransfer(nn.Module):
...
def build_mixstyle_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "mixstyle_small",
