...
_VARIANTS: dict[str, dict[str, int]] = {
    "mccnet_tiny": {"width": 24, "depth": 2},
    "mccnet_small": {"width": 32, "depth": 3},
    "mccnet_base": {"width": 48, "depth": 4},
}
...
def build_mccnet_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,  # kept for zoo signature consistency
    variant: str = "mccnet_small",
...
if __name__ == "__main__":
    ...
    m = build_mccnet_style_transfer(in_channels=3, variant="mccnet_tiny", width_mult=0.5)
    out = m(x, s)
    print("mccnet_tiny", tuple(out["stylized"].shape))
