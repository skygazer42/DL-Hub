...
_VARIANTS: dict[str, dict[str, int]] = {
    "deepstyle2_tiny": {"width": 24, "depth": 2},
    "deepstyle2_small": {"width": 32, "depth": 3},
    "deepstyle2_base": {"width": 48, "depth": 4},
}
...
class Deepstyle2StyleTransfer(nn.Module):
...
def build_deepstyle2_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "deepstyle2_small",
    ...
    return Deepstyle2StyleTransfer(
...
if __name__ == "__main__":
    ...
    m = build_deepstyle2_style_transfer(in_channels=3, variant="deepstyle2_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("deepstyle2_tiny", tuple(out["stylized"].shape))
