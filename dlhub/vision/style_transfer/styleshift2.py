...
_VARIANTS: dict[str, dict[str, int]] = {
    "styleshift2_tiny": {"width": 24, "depth": 2},
    "styleshift2_small": {"width": 32, "depth": 3},
    "styleshift2_base": {"width": 48, "depth": 4},
}
...
class Styleshift2StyleTransfer(nn.Module):
...
def build_styleshift2_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "styleshift2_small",
    ...
    return Styleshift2StyleTransfer(
...
if __name__ == "__main__":
    ...
    m = build_styleshift2_style_transfer(in_channels=3, variant="styleshift2_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("styleshift2_tiny", tuple(out["stylized"].shape))
