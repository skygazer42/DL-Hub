...
_VARIANTS: dict[str, dict[str, int]] = {
    "texturestyle_tiny": {"width": 24, "depth": 2},
    "texturestyle_small": {"width": 32, "depth": 3},
    "texturestyle_base": {"width": 48, "depth": 4},
}
...
def build_texturestyle_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "texturestyle_small",
    ...
    return TexturestyleStyleTransfer(
...
if __name__ == "__main__":
    ...
    m = build_texturestyle_style_transfer(in_channels=3, variant="texturestyle_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("texturestyle_tiny", tuple(out["stylized"].shape))
