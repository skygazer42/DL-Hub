...
_VARIANTS: dict[str, dict[str, int]] = {
    "vividstyle_tiny": {"width": 24, "depth": 2},
    "vividstyle_small": {"width": 32, "depth": 3},
    "vividstyle_base": {"width": 48, "depth": 4},
}
...
class VividstyleStyleTransfer(nn.Module):
...
def build_vividstyle_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "vividstyle_small",
    ...
    return VividstyleStyleTransfer(
...
if __name__ == "__main__":
    ...
    m = build_vividstyle_style_transfer(in_channels=3, variant="vividstyle_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("vividstyle_tiny", tuple(out["stylized"].shape))
