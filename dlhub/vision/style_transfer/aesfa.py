...
_VARIANTS: dict[str, dict[str, int]] = {
    "aesfa_tiny": {"width": 24, "depth": 2},
    "aesfa_small": {"width": 32, "depth": 3},
    "aesfa_base": {"width": 48, "depth": 4},
}
...
def build_aesfa_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,  # kept for zoo signature consistency
    variant: str = "aesfa_small",
...
if __name__ == "__main__":
    ...
    m = build_aesfa_style_transfer(in_channels=3, variant="aesfa_tiny", width_mult=0.5)
    out = m(x, s)
    print("aesfa_tiny", tuple(out["stylized"].shape))
