...
_VARIANTS: dict[str, dict[str, int]] = {
    "styleformer_tiny": {"width": 24, "depth": 2},
    "styleformer_small": {"width": 32, "depth": 3},
    "styleformer_base": {"width": 48, "depth": 4},
}
...
def build_styleformer_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "styleformer_small",
...
if __name__ == "__main__":
    ...
    m = build_styleformer_style_transfer(in_channels=3, variant="styleformer_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("styleformer_tiny", tuple(out["stylized"].shape))
