...
_VARIANTS: dict[str, dict[str, int]] = {
    "crossstyle_tiny": {"width": 24, "depth": 2},
    "crossstyle_small": {"width": 32, "depth": 3},
    "crossstyle_base": {"width": 48, "depth": 4},
}
...
def build_crossstyle_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "crossstyle_small",
...
if __name__ == "__main__":
    ...
    m = build_crossstyle_style_transfer(in_channels=3, variant="crossstyle_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("crossstyle_tiny", tuple(out["stylized"].shape))
