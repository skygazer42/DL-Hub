...
_VARIANTS: dict[str, dict[str, int]] = {
    "promptstyler_tiny": {"width": 24, "depth": 2},
    "promptstyler_small": {"width": 32, "depth": 3},
    "promptstyler_base": {"width": 48, "depth": 4},
}
...
def build_promptstyler_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "promptstyler_small",
...
if __name__ == "__main__":
    ...
    m = build_promptstyler_style_transfer(in_channels=3, variant="promptstyler_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("promptstyler_tiny", tuple(out["stylized"].shape))
