...
_VARIANTS: dict[str, dict[str, int]] = {
    "rsst_tiny": {"width": 24, "depth": 2},
    "rsst_small": {"width": 32, "depth": 3},
    "rsst_base": {"width": 48, "depth": 4},
}
...
def build_rsst_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "rsst_small",
...
if __name__ == "__main__":
    ...
    m = build_rsst_style_transfer(in_channels=3, variant="rsst_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("rsst_tiny", tuple(out["stylized"].shape))
