...
_VARIANTS: dict[str, dict[str, int]] = {
    "stytr2_tiny": {"width": 24, "depth": 2},
    "stytr2_small": {"width": 32, "depth": 3},
    "stytr2_base": {"width": 48, "depth": 4},
}
...
def build_stytr2_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "stytr2_small",
...
if __name__ == "__main__":
    ...
    m = build_stytr2_style_transfer(in_channels=3, variant="stytr2_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("stytr2_tiny", tuple(out["stylized"].shape))
