...
_VARIANTS: dict[str, dict[str, int]] = {
    "attnstyle_tiny": {"width": 24, "depth": 2},
    "attnstyle_small": {"width": 32, "depth": 3},
    "attnstyle_base": {"width": 48, "depth": 4},
}
...
class AttnstyleStyleTransfer(nn.Module):
...
def build_attnstyle_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,
    variant: str = "attnstyle_small",
...
if __name__ == "__main__":
    ...
    m = build_attnstyle_style_transfer(in_channels=3, variant="attnstyle_tiny", width_mult=0.5, num_layers=1)
    out = m(x, s)
    print("attnstyle_tiny", tuple(out["stylized"].shape))
