...
_VARIANTS: dict[str, dict[str, int]] = {
    "adain_tiny": {"width": 24, "depth": 2},
    "adain_small": {"width": 32, "depth": 3},
    "adain_base": {"width": 48, "depth": 4},
}
...
def build_adain_style_transfer(
    *,
    in_channels: int,
    image_size: int = 64,  # kept for zoo signature consistency
    variant: str = "adain_small",
...
if __name__ == "__main__":
    ...
    m = build_adain_style_transfer(in_channels=3, variant="adain_tiny", width_mult=0.5)
    out = m(x, s)
    print("adain_tiny", tuple(out["stylized"].shape))
