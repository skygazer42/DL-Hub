...
_VARIANTS: dict[str, dict[str, int]] = {
    "prompt_fsseg_tiny": {"width": 24, "depth": 1, "classes": 2},
    "prompt_fsseg_small": {"width": 36, "depth": 2, "classes": 2},
    "prompt_fsseg_base": {"width": 48, "depth": 3, "classes": 2},
}


def build_prompt_fsseg_few_shot_segmentor(
    *,
    in_channels: int,
