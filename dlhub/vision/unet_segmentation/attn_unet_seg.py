...
_VARIANTS: dict[str, dict[str, int]] = {'attn_unet_seg_tiny': {'width': 24, 'depth': 1, 'classes': 2}, 'attn_unet_seg_small': {'width': 36, 'depth': 2, 'classes': 2}, 'attn_unet_seg_base': {'width': 48, 'depth': 3, 'classes': 2}}
