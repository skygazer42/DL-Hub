...
_VARIANTS: dict[str, dict[str, int]] = {
    "prompt_finger_spread_tiny": {"width": 24, "depth": 1},
    "prompt_finger_spread_small": {"width": 36, "depth": 2},
    "prompt_finger_spread_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_hand_regressor(
        build_prompt_finger_spread_finger_spread_estimator, "prompt_finger_spread_tiny"
    )
