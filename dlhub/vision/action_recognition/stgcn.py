...
class STGCNSkeletonClassifier(nn.Module):
    def __init__(
        self,
        *,
        in_channels: int,
...
_VARIANTS: dict[str, dict] = {
    "stgcn_tiny": {"width": 32, "depth": 2, "kt": 5},
    "stgcn_small": {"width": 48, "depth": 3, "kt": 5},
    "stgcn_base": {"width": 64, "depth": 4, "kt": 9},
}


def build_stgcn_skeleton_classifier(
    *,
    in_channels: int,
    num_classes: int,
    num_joints: int = 17,
    seq_len: int = 32,
    variant: str = "stgcn_small",
    ...
    return STGCNSkeletonClassifier(
