...
_VARIANTS: dict[str, dict] = {
    "timesformer_tiny": {"patch": 8, "embed": 96, "depth": 2, "heads": 4},
    "timesformer_small": {"patch": 8, "embed": 128, "depth": 3, "heads": 4},
    "timesformer_base": {"patch": 4, "embed": 160, "depth": 4, "heads": 8},
}


def build_timesformer_video_classifier(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "timesformer_small",
    image_size: int = 64,
    frames: int = 8,
