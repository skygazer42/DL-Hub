...
class DeepSnake(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.contour = ContourDecoder(int(hidden_channels), num_vertices=int(num_vertices), mask_size=int(mask_size))
...
_VARIANTS: dict[str, dict[str, int]] = {
    "deepsnake_tiny": {"stem": 24, "p2": 40, "p3": 64, "p4": 96, "hidden": 96, "depth": 1, "instances": 16, "vertices": 16, "mask": 16},
    "deepsnake_small": {"stem": 24, "p2": 48, "p3": 80, "p4": 128, "hidden": 128, "depth": 2, "instances": 24, "vertices": 24, "mask": 16},
    "deepsnake_base": {"stem": 32, "p2": 64, "p3": 96, "p4": 160, "hidden": 160, "depth": 3, "instances": 32, "vertices": 32, "mask": 28},
}
...
if __name__ == "__main__":
    ...
    m = build_deepsnake_instance_segmenter(in_channels=3, num_classes=3, variant="deepsnake_tiny", width_mult=0.5)
    out = m(x)
