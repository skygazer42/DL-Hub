...
class InstanceFCN(nn.Module):
    """InstanceFCN-style position-sensitive instance segmentation."""
    ...
    def __init__(
        ...
        *,
        ...
        self.position_head = nn.Sequential(
            ...
            nn.Conv2d(int(hidden_channels), int(num_instances), kernel_size=1),
        )
...
def build_instancefcn_instance_segmenter(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "instancefcn_small",
