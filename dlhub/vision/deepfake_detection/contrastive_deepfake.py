...
_VARIANTS: dict[str, dict[str, int]] = {
    "contrastive_deepfake_tiny": {"width": 24, "depth": 1},
    "contrastive_deepfake_small": {"width": 36, "depth": 2},
    "contrastive_deepfake_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_deepfake_detector(
        build_contrastive_deepfake_deepfake_detector, "contrastive_deepfake_tiny"
    )
