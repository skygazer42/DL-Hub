...
_VARIANTS: dict[str, dict[str, int]] = {
    "multiview_deepfake_tiny": {"width": 24, "depth": 1},
    "multiview_deepfake_small": {"width": 36, "depth": 2},
    "multiview_deepfake_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_deepfake_detector(
        build_multiview_deepfake_deepfake_detector, "multiview_deepfake_tiny"
    )
