...
_VARIANTS: dict[str, dict[str, int]] = {
    "transformer_deepfake_tiny": {"width": 24, "depth": 1},
    "transformer_deepfake_small": {"width": 36, "depth": 2},
    "transformer_deepfake_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_deepfake_detector(
        build_transformer_deepfake_deepfake_detector, "transformer_deepfake_tiny"
    )
