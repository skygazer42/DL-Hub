...
_VARIANTS: dict[str, dict[str, int]] = {'cascade_anchorfree_tiny': {'width': 24, 'depth': 1, 'queries': 20}, 'cascade_anchorfree_small': {'width': 36, 'depth': 2, 'queries': 24}, 'cascade_anchorfree_base': {'width': 48, 'depth': 3, 'queries': 32}}
