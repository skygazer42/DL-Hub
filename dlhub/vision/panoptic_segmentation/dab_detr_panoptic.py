...
class DABDETRPanoptic(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.anchors = nn.Parameter(torch.rand(q, 4))
        self.anchor_proj = nn.Linear(4, dm)
...
def build_dab_detr_panoptic_segmenter(
    *,
    in_channels: int,
    num_thing_classes: int,
    num_stuff_classes: int,
    variant: str = "dab_detr_panoptic_small",
