...
_VARIANTS: dict[str, dict[str, int]] = {'gatys_translation_tiny': {'width': 24, 'depth': 1}, 'gatys_translation_small': {'width': 36, 'depth': 2}, 'gatys_translation_base': {'width': 48, 'depth': 3}}
