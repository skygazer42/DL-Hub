...
_VARIANTS: dict[str, dict[str, int]] = {'pix2pix_translation_tiny': {'width': 24, 'depth': 1}, 'pix2pix_translation_small': {'width': 36, 'depth': 2}, 'pix2pix_translation_base': {'width': 48, 'depth': 3}}
