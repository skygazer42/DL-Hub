...
_VARIANTS: dict[str, dict[str, int]] = {'prompt_translation_tiny': {'width': 24, 'depth': 1}, 'prompt_translation_small': {'width': 36, 'depth': 2}, 'prompt_translation_base': {'width': 48, 'depth': 3}}
