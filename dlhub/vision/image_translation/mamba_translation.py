...
_VARIANTS: dict[str, dict[str, int]] = {'mamba_translation_tiny': {'width': 24, 'depth': 1}, 'mamba_translation_small': {'width': 36, 'depth': 2}, 'mamba_translation_base': {'width': 48, 'depth': 3}}
