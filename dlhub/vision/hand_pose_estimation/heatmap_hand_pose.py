...
_VARIANTS: dict[str, dict[str, int]] = {
    "heatmap_hand_pose_tiny": {"width": 24, "depth": 1, "num_keypoints": 10},
    "heatmap_hand_pose_small": {"width": 36, "depth": 2, "num_keypoints": 10},
    "heatmap_hand_pose_base": {"width": 48, "depth": 3, "num_keypoints": 10},
}
...
if __name__ == "__main__":
    smoke_test_hand_pose_estimator(
        build_heatmap_hand_pose_hand_pose_estimator, "heatmap_hand_pose_tiny"
    )
