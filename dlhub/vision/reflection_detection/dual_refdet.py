...
_VARIANTS: dict[str, dict[str, int]] = {
    "dual_refdet_tiny": {"width": 24, "depth": 1},
    "dual_refdet_small": {"width": 36, "depth": 2},
    "dual_refdet_base": {"width": 48, "depth": 3},
}


def build_dual_refdet_reflection_detector(
    *, in_channels: int, variant: str = "dual_refdet_small", width_mult: float = 1.0
) -> nn.Module:
