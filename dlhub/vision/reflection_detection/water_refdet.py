...
_VARIANTS: dict[str, dict[str, int]] = {
    "water_refdet_tiny": {"width": 24, "depth": 1},
    "water_refdet_small": {"width": 36, "depth": 2},
    "water_refdet_base": {"width": 48, "depth": 3},
}


def build_water_refdet_reflection_detector(
    *, in_channels: int, variant: str = "water_refdet_small", width_mult: float = 1.0
) -> nn.Module:
