...
_VARIANTS: dict[str, dict[str, int]] = {'diffusion_salient_tiny': {'width': 24, 'depth': 1}, 'diffusion_salient_small': {'width': 36, 'depth': 2}, 'diffusion_salient_base': {'width': 48, 'depth': 3}}
