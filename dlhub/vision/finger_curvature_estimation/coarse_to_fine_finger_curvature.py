...
_VARIANTS: dict[str, dict[str, int]] = {
    "coarse_to_fine_finger_curvature_tiny": {"width": 24, "depth": 1},
    "coarse_to_fine_finger_curvature_small": {"width": 36, "depth": 2},
    "coarse_to_fine_finger_curvature_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_hand_regressor(
        build_coarse_to_fine_finger_curvature_finger_curvature_estimator,
        "coarse_to_fine_finger_curvature_tiny",
    )
