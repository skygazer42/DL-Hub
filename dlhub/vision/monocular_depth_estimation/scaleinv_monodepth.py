...
_VARIANTS: dict[str, dict[str, int]] = {'scaleinv_monodepth_tiny': {'width': 24, 'depth': 1}, 'scaleinv_monodepth_small': {'width': 36, 'depth': 2}, 'scaleinv_monodepth_base': {'width': 48, 'depth': 3}}
