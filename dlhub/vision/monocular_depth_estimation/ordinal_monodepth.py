...
_VARIANTS: dict[str, dict[str, int]] = {'ordinal_monodepth_tiny': {'width': 24, 'depth': 1}, 'ordinal_monodepth_small': {'width': 36, 'depth': 2}, 'ordinal_monodepth_base': {'width': 48, 'depth': 3}}
