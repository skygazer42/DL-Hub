...
_VARIANTS: dict[str, dict[str, int]] = {
    "mamba_car_tiny": {"width": 24, "depth": 1, "steps": 1},
    "mamba_car_small": {"width": 36, "depth": 2, "steps": 1},
    "mamba_car_base": {"width": 48, "depth": 3, "steps": 2},
}


def build_mamba_car_artifact_reducer(
    *,
    in_channels: int,
    variant: str = "mamba_car_small",
