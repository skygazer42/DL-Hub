...
_VARIANTS: dict[str, str] = {
    "decola_tiny": "dino_tiny",
    "decola_small": "dino_small",
    "decola_base": "dino_base",
}


def build_decola_detector(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "decola_tiny",
...
if __name__ == "__main__":
    smoke_aliased_detector(label="decola_tiny", builder=build_decola_detector, variant="decola_tiny")
