...
_VARIANTS: dict[str, str] = {
    "unitbox_tiny": "fcos_tiny",
    "unitbox_small": "fcos_small",
    "unitbox_base": "fcos_base",
}


def build_unitbox_detector(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "unitbox_tiny",
...
if __name__ == "__main__":
    smoke_aliased_detector(label="unitbox_tiny", builder=build_unitbox_detector, variant="unitbox_tiny")
