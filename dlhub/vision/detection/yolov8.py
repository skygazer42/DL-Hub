...
if __name__ == "__main__":
    ...
    m = build_yolov8_detector(in_channels=3, num_classes=3, variant="yolov8_tiny", width_mult=0.5)
    out = m(x)
    print("yolov8_tiny", [tuple(t.shape) for t in out["obj_logits"]])
    loss = (
