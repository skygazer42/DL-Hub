...
_VARIANTS: dict[str, str] = {
    "pedestrian_yolov10": "yolov10_tiny",
}


def build_pedestrian_yolov10_detector(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "pedestrian_yolov10",
...
if __name__ == "__main__":
    smoke_aliased_detector(
        label="pedestrian_yolov10",
        builder=build_pedestrian_yolov10_detector,
        variant="pedestrian_yolov10",
    )
