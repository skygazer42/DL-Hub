...
_VARIANTS: dict[str, str] = {
    "h_detr_tiny": "dino_tiny",
    "h_detr_small": "dino_small",
    "h_detr_base": "dino_base",
}


def build_h_detr_detector(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "h_detr_tiny",
...
if __name__ == "__main__":
    smoke_aliased_detector(label="h_detr_tiny", builder=build_h_detr_detector, variant="h_detr_tiny")
