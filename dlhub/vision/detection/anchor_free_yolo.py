...
class AnchorFreeYoloDetector(nn.Module):
...
def build_anchor_free_yolo_detector(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "anchor_free_yolo_tiny",
