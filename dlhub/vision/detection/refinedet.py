...
_VARIANTS: dict[str, str] = {
    "refinedet_tiny": "dssd_tiny",
    "refinedet_small": "dssd_small",
    "refinedet_base": "dssd_base",
}


def build_refinedet_detector(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "refinedet_tiny",
...
if __name__ == "__main__":
    smoke_aliased_detector(
        label="refinedet_tiny",
        builder=build_refinedet_detector,
        variant="refinedet_tiny",
    )
