...
_VARIANTS: dict[str, str] = {
    "ovlw_detr_tiny": "dino_tiny",
    "ovlw_detr_small": "dino_small",
    "ovlw_detr_base": "dino_base",
}


def build_ovlw_detr_detector(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "ovlw_detr_tiny",
...
if __name__ == "__main__":
    smoke_aliased_detector(
        label="ovlw_detr_tiny",
        builder=build_ovlw_detr_detector,
        variant="ovlw_detr_tiny",
    )
