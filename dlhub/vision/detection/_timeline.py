...
_ENTRIES: list[TimelineEntry] = [
    ...
    TimelineEntry(2015, "densebox", "DenseBox (dense regression detector, toy)", "keypoint_anchor_free"),
    TimelineEntry(2016, "ssd", "SSD (single-shot multi-scale detector)", "single_stage"),
    TimelineEntry(2016, "squeezedet", "SqueezeDet (compact single-shot detector, toy)", "single_stage"),
    TimelineEntry(2016, "rfcn", "R-FCN (region-based fully convolutional detector, toy)", "two_stage"),
    TimelineEntry(2016, "unitbox", "UnitBox (IoU-aware box regression, toy)", "keypoint_anchor_free"),
    ...
    TimelineEntry(2017, "mask_rcnn", "Mask R-CNN (instance-aware two-stage detector, toy)", "two_stage"),
    TimelineEntry(2017, "yolov2", "YOLOv2 (anchor-based YOLO, toy)", "single_stage"),
    TimelineEntry(2017, "ron", "RON (reverse connection with objectness prior, toy)", "single_stage"),
    TimelineEntry(2017, "point_linking_network", "Point Linking Network (point-based detector, toy)", "keypoint_anchor_free"),
    TimelineEntry(2018, "cornernet", "CornerNet (paired keypoint detector, toy)", "keypoint_anchor_free"),
    ...
    TimelineEntry(2018, "refinedet", "RefineDet (refinement-based one-stage detector, toy)", "single_stage"),
    ...
    TimelineEntry(2019, "extremenet", "ExtremeNet (extreme-point detector, toy)", "keypoint_anchor_free"),
    TimelineEntry(2019, "fcos", "FCOS (fully convolutional one-stage detector, toy)", "keypoint_anchor_free"),
    TimelineEntry(2019, "foveabox", "FoveaBox (foveated anchor-free detector, toy)", "keypoint_anchor_free"),
    TimelineEntry(2019, "freeanchor", "FreeAnchor (anchor assignment refinement, toy)", "single_stage"),
    TimelineEntry(2019, "reppoints", "RepPoints (point-set detector, toy)", "keypoint_anchor_free"),
    TimelineEntry(2019, "tridentnet", "TridentNet (scale-aware multi-branch detector, toy)", "two_stage"),
    TimelineEntry(2019, "libra_rcnn", "Libra R-CNN (balanced sampling and heads, toy)", "two_stage"),
    TimelineEntry(2019, "grid_rcnn", "Grid R-CNN (grid-guided box localization, toy)", "two_stage"),
    TimelineEntry(2019, "guided_anchoring_rcnn", "Guided Anchoring R-CNN (dynamic anchor guidance, toy)", "two_stage"),
    TimelineEntry(2019, "detectors", "DetectoRS (recursive feature pyramid detector, toy)", "two_stage"),
    TimelineEntry(2019, "m2det", "M2Det (multi-level feature pyramid detector, toy)", "single_stage"),
    TimelineEntry(2020, "detr", "DETR (set prediction with transformer queries)", "transformer_query"),
    TimelineEntry(2020, "efficientdet", "EfficientDet (BiFPN one-stage detector, toy)", "single_stage"),
    ...
    TimelineEntry(2020, "paa", "PAA (probabilistic anchor assignment detector, toy)", "single_stage"),
    TimelineEntry(2020, "ttfnet", "TTFNet (keypoint heatmap detector, toy)", "keypoint_anchor_free"),
    ...
    TimelineEntry(2020, "ppyolo", "PP-YOLO (bag-of-freebies single-stage detector, toy)", "single_stage"),
    TimelineEntry(2020, "borderdet", "BorderDet (border-aware anchor-free detector, toy)", "keypoint_anchor_free"),
    TimelineEntry(2020, "autoassign", "AutoAssign (fully differentiable label assignment, toy)", "keypoint_anchor_free"),
    TimelineEntry(2020, "dynamic_rcnn", "Dynamic R-CNN (adaptive training detector, toy)", "two_stage"),
    TimelineEntry(2021, "conditional_detr", "Conditional DETR (conditional query detector, toy)", "transformer_query"),
    TimelineEntry(2021, "deformable_detr", "Deformable DETR (multi-scale deformable queries, toy)", "transformer_query"),
    TimelineEntry(2021, "dn_detr", "DN-DETR (denoising query detector, toy)", "transformer_query"),
    TimelineEntry(2021, "fsaf", "FSAF (feature selective anchor-free detector, toy)", "keypoint_anchor_free"),
    TimelineEntry(2021, "tood", "TOOD (task-aligned one-stage detector, toy)", "single_stage"),
    TimelineEntry(2021, "varifocalnet", "VarifocalNet (quality-aware one-stage detector, toy)", "single_stage"),
    ...
    TimelineEntry(2021, "yolox", "YOLOX (anchor-free decoupled head detector, toy)", "single_stage"),
    TimelineEntry(2021, "smca_detr", "SMCA-DETR (spatially modulated co-attention, toy)", "transformer_query"),
    TimelineEntry(2021, "yolos", "YOLOS (ViT-style detector with tokens, toy)", "transformer_query"),
    TimelineEntry(2021, "scaled_yolov4", "Scaled-YOLOv4 (scaled YOLO detector, toy)", "single_stage"),
    TimelineEntry(2021, "ppyolov2", "PP-YOLOv2 (improved PP-YOLO detector, toy)", "single_stage"),
    TimelineEntry(2021, "giraffedet", "GiraffeDet (lightweight feature fusion detector, toy)", "single_stage"),
    TimelineEntry(2021, "centernet2", "CenterNet2 (proposal-enhanced point detector, toy)", "keypoint_anchor_free"),
    TimelineEntry(2021, "vild", "ViLD (open-vocabulary distillation detector, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2022, "dab_detr", "DAB-DETR (dynamic anchor boxes as queries, toy)", "transformer_query"),
    TimelineEntry(2022, "dino", "DINO (denoising anchor boxes with contrastive learning, toy)", "transformer_query"),
    ...
    TimelineEntry(2022, "sparse_rcnn", "Sparse R-CNN (learned proposal queries)", "transformer_query"),
    TimelineEntry(2022, "anchor_detr", "Anchor DETR (anchor-guided queries, toy)", "transformer_query"),
    TimelineEntry(2022, "adamixer", "AdaMixer (adaptive query mixing detector, toy)", "transformer_query"),
    TimelineEntry(2022, "efficient_detr", "Efficient DETR (efficient transformer detector, toy)", "transformer_query"),
    ...
    TimelineEntry(2022, "damo_yolo", "DAMO-YOLO (NAS/lightweight YOLO detector, toy)", "single_stage"),
    TimelineEntry(2022, "regionclip", "RegionCLIP (region-text aligned detector, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2022, "glip", "GLIP (grounded language-image pretraining detector, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2022, "detclip", "DetCLIP (open-vocabulary contrastive detector, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2023, "rtdetr", "RT-DETR (real-time transformer detector, toy)", "transformer_query"),
    TimelineEntry(2023, "yolov8", "YOLOv8 (C2f anchor-free detector, toy)", "single_stage"),
    TimelineEntry(2023, "co_detr", "Co-DETR (collaborative hybrid assignment detector, toy)", "transformer_query"),
    TimelineEntry(2023, "group_detr", "Group DETR (grouped query optimization detector, toy)", "transformer_query"),
    TimelineEntry(2023, "h_detr", "H-DETR (hybrid matching DETR variant, toy)", "transformer_query"),
    TimelineEntry(2023, "gold_yolo", "Gold-YOLO (efficient aggregation detector, toy)", "single_stage"),
    TimelineEntry(2023, "owl_vit", "OWL-ViT (open-vocabulary vision transformer detector, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2023, "grounding_dino", "Grounding DINO (grounded open-set detector, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2023, "detclipv2", "DetCLIPv2 (scalable open-vocabulary detector, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2024, "yolov9", "YOLOv9 (programmable gradient YOLO detector, toy)", "single_stage"),
    TimelineEntry(2024, "yolov10", "YOLOv10 (NMS-free real-time YOLO detector, toy)", "single_stage"),
    TimelineEntry(2024, "yolo11", "YOLO11 (Ultralytics unified detector family, toy)", "single_stage"),
    TimelineEntry(2024, "d_fine", "D-FINE (real-time detector with distribution refinement, toy)", "transformer_query"),
    TimelineEntry(2024, "lw_detr", "LW-DETR (lightweight DETR-style detector, toy)", "transformer_query"),
    TimelineEntry(2024, "ovlw_detr", "OVLW-DETR (open-vocabulary lightweight DETR, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2024, "ddq_detr", "DDQ-DETR (dense dynamic queries, toy)", "transformer_query"),
    TimelineEntry(2024, "yolo_world", "YOLO-World (real-time open-vocabulary YOLO, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2024, "decola", "DECOLA (language-conditioned detection transformer, toy)", "open_vocabulary_multimodal"),
    ...
    TimelineEntry(2025, "rtgen", "RTGen (real-time open-ended detection with generative VLMs, toy)", "open_vocabulary_multimodal"),
    TimelineEntry(2025, "sa_detr", "SA-DETR (scale-adaptive DETR-style detector, toy)", "transformer_query"),
    TimelineEntry(2026, "yolo26", "YOLO26 (latest Ultralytics real-time detector, toy)", "single_stage"),
]
