...
_VARIANTS: dict[str, str] = {
    "pedestrian_yolov5": "yolov5_tiny",
}


def build_pedestrian_yolov5_detector(
    *,
    in_channels: int,
    num_classes: int,
    variant: str = "pedestrian_yolov5",
...
if __name__ == "__main__":
    smoke_aliased_detector(
        label="pedestrian_yolov5",
        builder=build_pedestrian_yolov5_detector,
        variant="pedestrian_yolov5",
    )
