...
_VARIANTS: dict[str, dict[str, int]] = {
    "attention_attr_face_tiny": {"width": 24, "depth": 1},
    "attention_attr_face_small": {"width": 36, "depth": 2},
    "attention_attr_face_base": {"width": 48, "depth": 3},
}
...
if __name__ == "__main__":
    smoke_test_face_attribute_recognizer(
        build_attention_attr_face_attribute_recognizer, "attention_attr_face_tiny"
    )
