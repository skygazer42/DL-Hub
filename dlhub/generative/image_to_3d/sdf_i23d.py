...
def build_sdf_i23d_image_to_3d_generator(*, in_channels: int, variant: str = "sdf_i23d_small", width_mult: float = 1.0) -> nn.Module:
    return build_toy_image_to_3d_generator(family="sdf_i23d", mode="sdf", variants=_VARIANTS, in_channels=int(in_channels), variant=str(variant), width_mult=float(width_mult))
