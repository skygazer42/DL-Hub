...
_VARIANTS: dict[str, dict[str, int]] = {
    ...
    "action_conditioned_world_small": {
        "width": 76,
        "depth": 3,
        "latent": 76,
        "action": 8,
...
def build_action_conditioned_world_world_model(
    *,
    in_channels: int = 3,
    action_dim: int = 6,
    context_dim: int = 10,
...
if __name__ == "__main__":
    smoke_test_world_model(
        build_action_conditioned_world_world_model, "action_conditioned_world_tiny"
    )
