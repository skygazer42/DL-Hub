...
_VARIANTS: dict[str, dict[str, int]] = {
    "flux_tiny": {"width": 64, "depth": 2, "latent": 64},
    "flux_small": {"width": 96, "depth": 3, "latent": 96},
    "flux_base": {"width": 128, "depth": 4, "latent": 128},
}


def build_flux_diffusion(
    *,
    in_channels: int,
    image_size: int = 32,
    latent_dim: int = 64,
    num_classes: int = 0,
    variant: str = "flux_tiny",
