...
_VARIANTS: dict[str, dict[str, int]] = {
    ...
    "diffusion_t2v_small": {"width": 32, "depth": 2, "frames": 5},
    "diffusion_t2v_base": {"width": 48, "depth": 3, "frames": 6},
}
...
if __name__ == "__main__":
    smoke_test_text_to_video(build_diffusion_t2v_text_to_video, "diffusion_t2v_tiny")
