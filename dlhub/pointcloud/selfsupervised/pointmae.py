...
class PointMAEPretrainer(nn.Module):
...
if __name__ == "__main__":
    ...
    m = build_pointmae_pretrainer(in_channels=3, variant="pointmae_tiny", dropout=0.0)
