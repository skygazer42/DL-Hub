...
class DinoSSLPointPretrainer(nn.Module):
...
def build_dinossl_point_pretrainer(
    *,
    in_channels: int,
    variant: str = "dinossl_point_small",
    dropout: float = 0.0,
) -> nn.Module:
...
if __name__ == "__main__":
    ...
    m = build_dinossl_point_pretrainer(in_channels=3, variant="dinossl_point_tiny", dropout=0.0)
