...
class ClipPointSSLPretrainer(nn.Module):
...
def build_clip_point_ssl_pretrainer(
    *,
    in_channels: int,
    variant: str = "clip_point_ssl_small",
    dropout: float = 0.0,
) -> nn.Module:
...
if __name__ == "__main__":
    ...
    m = build_clip_point_ssl_pretrainer(in_channels=3, variant="clip_point_ssl_tiny", dropout=0.0)
