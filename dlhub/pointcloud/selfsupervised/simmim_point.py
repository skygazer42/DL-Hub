...
class SimMimPointPretrainer(nn.Module):
...
def build_simmim_point_pretrainer(
    *,
    in_channels: int,
    variant: str = "simmim_point_small",
    dropout: float = 0.0,
) -> nn.Module:
...
if __name__ == "__main__":
    ...
    m = build_simmim_point_pretrainer(in_channels=3, variant="simmim_point_tiny", dropout=0.0)
