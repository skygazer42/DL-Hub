...
def build_maskedpoint_pretrainer(
    *,
    in_channels: int,
    variant: str = "maskedpoint_small",
    dropout: float = 0.0,
) -> nn.Module:
...
if __name__ == "__main__":
    ...
    m = build_maskedpoint_pretrainer(in_channels=3, variant="maskedpoint_tiny", dropout=0.0)
