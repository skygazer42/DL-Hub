...
class SimCLRV3PointNet(nn.Module):
...
_VARIANTS: dict[str, dict] = {
    "simclrv3_point_pointnet_tiny": {"hidden": 32, "embed": 64, "proj": 32, "dropout": 0.0},
    "simclrv3_point_pointnet_small": {"hidden": 64, "embed": 128, "proj": 64, "dropout": 0.0},
    "simclrv3_point_pointnet_base": {"hidden": 96, "embed": 192, "proj": 96, "dropout": 0.0},
}


def build_simclrv3_point_pointnet(
    *,
    in_channels: int,
    variant: str = "simclrv3_point_pointnet_small",
...
if __name__ == "__main__":
    ...
    m = build_simclrv3_point_pointnet(in_channels=3, variant="simclrv3_point_pointnet_tiny")
    out1 = m(pts)
