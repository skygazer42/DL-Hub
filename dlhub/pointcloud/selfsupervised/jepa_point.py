...
class JepaPointPretrainer(nn.Module):
...
def build_jepa_point_pretrainer(
    *,
    in_channels: int,
    variant: str = "jepa_point_small",
    dropout: float = 0.0,
) -> nn.Module:
...
if __name__ == "__main__":
    ...
    m = build_jepa_point_pretrainer(in_channels=3, variant="jepa_point_tiny", dropout=0.0)
