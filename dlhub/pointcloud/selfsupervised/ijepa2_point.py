...
def build_ijepa2_point_pointmae(
    *,
    in_channels: int,
    variant: str = "ijepa2_point_pointmae_small",
...
if __name__ == "__main__":
    ...
    loss = ijepa2_point_patch_loss(s["pred"], t, s["mask_idx"])
    loss.backward()
