...
class SimCLRPointNet(nn.Module):
...
_VARIANTS: dict[str, dict] = {
    "simclr_pointnet_tiny": {"hidden": 32, "embed": 64, "proj": 32, "dropout": 0.0},
    "simclr_pointnet_small": {"hidden": 64, "embed": 128, "proj": 64, "dropout": 0.0},
    "simclr_pointnet_base": {"hidden": 96, "embed": 192, "proj": 96, "dropout": 0.0},
}


def build_simclr_pointnet(
    *,
    in_channels: int,
...
if __name__ == "__main__":
    ...
    m = build_simclr_pointnet(in_channels=3, variant="simclr_pointnet_tiny")
    out1 = m(pts)
