...
class BarlowTwinsPointNet(nn.Module):
...
_VARIANTS: dict[str, dict] = {
    "barlowtwins_pointnet_tiny": {"hidden": 32, "embed": 64, "proj": 128, "dropout": 0.0},
    "barlowtwins_pointnet_small": {"hidden": 64, "embed": 128, "proj": 256, "dropout": 0.0},
    "barlowtwins_pointnet_base": {"hidden": 96, "embed": 192, "proj": 384, "dropout": 0.0},
}


def build_barlowtwins_pointnet(
    *,
    in_channels: int,
...
if __name__ == "__main__":
    ...
    m = build_barlowtwins_pointnet(in_channels=3, variant="barlowtwins_pointnet_tiny")
    o1 = m(v1)
    o2 = m(v2)
