...
class MaeSSLPointPretrainer(nn.Module):
...
def build_maessl_point_pretrainer(
    *,
    in_channels: int,
    variant: str = "maessl_point_small",
    dropout: float = 0.0,
) -> nn.Module:
...
if __name__ == "__main__":
    ...
    m = build_maessl_point_pretrainer(in_channels=3, variant="maessl_point_tiny", dropout=0.0)
