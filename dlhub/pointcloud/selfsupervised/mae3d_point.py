...
class Mae3DPointPretrainer(nn.Module):
...
def build_mae3d_point_pretrainer(
    *,
    in_channels: int,
    variant: str = "mae3d_point_small",
    dropout: float = 0.0,
) -> nn.Module:
...
if __name__ == "__main__":
    ...
    m = build_mae3d_point_pretrainer(in_channels=3, variant="mae3d_point_tiny", dropout=0.0)
