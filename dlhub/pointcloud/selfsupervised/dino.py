...
_VARIANTS: dict[str, dict] = {
    "dino_pointnet_tiny": {"hidden": 32, "embed": 64, "proj": 128, "out": 64, "dropout": 0.0},
    "dino_pointnet_small": {"hidden": 64, "embed": 128, "proj": 256, "out": 128, "dropout": 0.0},
    "dino_pointnet_base": {"hidden": 96, "embed": 192, "proj": 384, "out": 256, "dropout": 0.0},
}


def build_dino_pointnet(
    *,
    in_channels: int,
...
if __name__ == "__main__":
    ...
    m = build_dino_pointnet(in_channels=3, variant="dino_pointnet_tiny")
