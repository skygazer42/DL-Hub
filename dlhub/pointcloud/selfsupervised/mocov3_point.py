...
class MoCoV3PointNet(nn.Module):
    ...
    def forward(
        ...
        logits, labels = mocov3_point_logits(q, k, self.queue, temperature=float(temperature))
...
def build_mocov3_point_pointnet(
    *,
    in_channels: int,
    variant: str = "mocov3_point_pointnet_small",
...
if __name__ == "__main__":
    ...
    m = build_mocov3_point_pointnet(in_channels=3, variant="mocov3_point_pointnet_tiny")
