...
class VICRegPointNet(nn.Module):
...
_VARIANTS: dict[str, dict] = {
    "vicreg_pointnet_tiny": {"hidden": 32, "embed": 64, "proj": 64, "dropout": 0.0},
    "vicreg_pointnet_small": {"hidden": 64, "embed": 128, "proj": 128, "dropout": 0.0},
    "vicreg_pointnet_base": {"hidden": 96, "embed": 192, "proj": 192, "dropout": 0.0},
}


def build_vicreg_pointnet(
    *,
    in_channels: int,
...
if __name__ == "__main__":
    ...
    m = build_vicreg_pointnet(in_channels=3, variant="vicreg_pointnet_tiny")
    out1 = m(v1)
    out2 = m(v2)
