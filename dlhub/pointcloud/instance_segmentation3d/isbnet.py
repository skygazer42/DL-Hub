...
_VARIANTS: dict[str, dict[str, object]] = {
    "isbnet_tiny": {"d_model": 64, "depth": 2, "queries": 16},
    "isbnet_small": {"d_model": 96, "depth": 3, "queries": 24},
    "isbnet_base": {"d_model": 128, "depth": 4, "queries": 32},
}
...
def build_isbnet_instance_segmenter3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "isbnet_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_isbnet_instance_segmenter3d(in_channels=3, num_classes=6, variant="isbnet_tiny")
