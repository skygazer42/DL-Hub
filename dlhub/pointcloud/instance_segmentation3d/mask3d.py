...
_VARIANTS: dict[str, dict[str, object]] = {
    ...
    "mask3d_small": {"d_model": 96, "depth": 3, "queries": 24},
    "mask3d_base": {"d_model": 128, "depth": 4, "queries": 32},
}


class Mask3D(nn.Module):
    """Mask3D (compact): transformer point encoder + query mask head."""
...
def build_mask3d_instance_segmenter3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "mask3d_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_mask3d_instance_segmenter3d(in_channels=3, num_classes=6, variant="mask3d_tiny")
