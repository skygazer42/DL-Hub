...
_VARIANTS: dict[str, dict[str, object]] = {
    "pointins3d_tiny": {"width": 64, "depth": 2, "k": 8, "instances": 16},
    "pointins3d_small": {"width": 96, "depth": 3, "k": 16, "instances": 24},
    "pointins3d_base": {"width": 128, "depth": 4, "k": 24, "instances": 32},
}
...
def build_pointins3d_instance_segmenter3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "pointins3d_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_pointins3d_instance_segmenter3d(
        in_channels=3, num_classes=6, variant="pointins3d_tiny"
    )
