...
_VARIANTS: dict[str, dict[str, object]] = {
    "oneformer3d_tiny": {"d_model": 64, "depth": 2, "queries": 16},
    "oneformer3d_small": {"d_model": 96, "depth": 3, "queries": 24},
    "oneformer3d_base": {"d_model": 128, "depth": 4, "queries": 32},
}
...
def build_oneformer3d_instance_segmenter3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "oneformer3d_small",
