...
class Groupformer3D(nn.Module):
    """Groupformer3D (toy): transformer point encoder + query mask head."""
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_groupformer3d_instance_segmenter3d(in_channels=3, num_classes=6, variant="groupformer3d_tiny")
