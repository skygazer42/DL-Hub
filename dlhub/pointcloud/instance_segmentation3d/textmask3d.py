...
_VARIANTS: dict[str, dict[str, object]] = {
    "textmask3d_tiny": {"d_model": 64, "depth": 2, "queries": 16},
    "textmask3d_small": {"d_model": 96, "depth": 3, "queries": 24},
    "textmask3d_base": {"d_model": 128, "depth": 4, "queries": 32},
}


class TextMask3D(nn.Module):
    """TextMask3D (compact): transformer point encoder + query mask head."""
...
def build_texttextmask3d_instance_segmenter3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "textmask3d_small",
