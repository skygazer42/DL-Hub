...
_VARIANTS: dict[str, dict[str, object]] = {
    ...
    "softgroup_small": {"width": 96, "depth": 3, "k": 16, "instances": 24},
    "softgroup_base": {"width": 128, "depth": 4, "k": 24, "instances": 32},
}
...
def build_softgroup_instance_segmenter3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "softgroup_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_softgroup_instance_segmenter3d(in_channels=3, num_classes=6, variant="softgroup_tiny")
