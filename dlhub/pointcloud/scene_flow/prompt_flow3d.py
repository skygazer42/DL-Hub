...
_VARIANTS: dict[str, dict[str, int | float]] = {
    "prompt_flow3d_tiny": {"width": 56, "depth": 3, "hidden_mult": 3, "refine_steps": 2, "delta_scale": 0.9},
    "prompt_flow3d_small": {"width": 88, "depth": 4, "hidden_mult": 3, "refine_steps": 3, "delta_scale": 0.95},
    "prompt_flow3d_base": {"width": 120, "depth": 5, "hidden_mult": 3, "refine_steps": 4, "delta_scale": 1.0},
}
