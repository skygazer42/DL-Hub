...
_VARIANTS: dict[str, dict] = {
    "pointnet_ae_tiny": {"hidden": 32, "latent": 64, "dropout": 0.0},
    "pointnet_ae_small": {"hidden": 64, "latent": 128, "dropout": 0.0},
    "pointnet_ae_base": {"hidden": 96, "latent": 192, "dropout": 0.0},
}


def build_pointnet_autoencoder(
    *,
    in_channels: int,
    num_points: int,
