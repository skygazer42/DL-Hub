...
def build_cycle_corr3d_shape_correspondence_model(
    *, in_channels: int, variant: str = "cycle_corr3d_small", width_mult: float = 1.0
) -> nn.Module:
...
if __name__ == "__main__":
    smoke_test_shape_correspondence_model(
        build_cycle_corr3d_shape_correspondence_model, "cycle_corr3d_tiny"
    )
