...
_VARIANTS: dict[str, dict[str, object]] = {
    ...
    "point_transformer_small": {"d_model": 96, "depth": 3},
    "point_transformer_base": {"d_model": 128, "depth": 4},
}
...
def build_point_transformer_segmenter3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "point_transformer_small",
