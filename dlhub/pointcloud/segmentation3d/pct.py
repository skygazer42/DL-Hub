...
_VARIANTS: dict[str, dict[str, object]] = {
    ...
    "pct_small": {"d_model": 96, "depth": 3, "pos_feats": 12},
    "pct_base": {"d_model": 128, "depth": 4, "pos_feats": 16},
}
...
def build_pct_segmenter3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "pct_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    model = build_pct_segmenter3d(in_channels=3, num_classes=6, variant="pct_tiny")
