...
_VARIANTS: dict[str, dict[str, object]] = {
    "pointsea_tiny": {"d_model": 64, "depth": 3},
    "pointsea_small": {"d_model": 96, "depth": 4},
    "pointsea_base": {"d_model": 128, "depth": 6},
}
...
def build_pointsea_segmenter3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "pointsea_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    model = build_pointsea_segmenter3d(in_channels=3, num_classes=6, variant="pointsea_tiny")
