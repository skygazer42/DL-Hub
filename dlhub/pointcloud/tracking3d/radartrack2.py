...
_VARIANTS: dict[str, dict[str, int]] = {
    "radartrack2_tiny": {"width": 48, "tracks": 24},
    "radartrack2_small": {"width": 64, "tracks": 32},
    "radartrack2_base": {"width": 96, "tracks": 48},
}


def build_radartrack2_tracker3d(
    *,
    in_channels: int,
    num_classes: int,
    seq_len: int = 4,
    variant: str = "radartrack2_tiny",
