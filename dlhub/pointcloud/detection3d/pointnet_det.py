...
_VARIANTS: dict[str, dict[str, object]] = {
    ...
    "pointnet_det_small": {"d_model": 96, "queries": 48},
    "pointnet_det_base": {"d_model": 128, "queries": 64},
}
...
def build_pointnet_det_detector3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "pointnet_det_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_pointnet_det_detector3d(in_channels=3, num_classes=3, variant="pointnet_det_tiny")
