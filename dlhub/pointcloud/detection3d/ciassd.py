...
_VARIANTS: dict[str, dict[str, object]] = {
    ...
    "ciassd_small": {"width": 96, "keypoints": 96},
    "ciassd_base": {"width": 128, "keypoints": 128},
}
...
def build_ciassd_detector3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "ciassd_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_ciassd_detector3d(in_channels=3, num_classes=3, variant="ciassd_tiny")
