...
_VARIANTS: dict[str, dict[str, object]] = {
    "afdet_tiny": {"width": 48, "bev_h": 32, "bev_w": 32, "topk": 64},
    "afdet_small": {"width": 64, "bev_h": 40, "bev_w": 40, "topk": 96},
    "afdet_base": {"width": 96, "bev_h": 48, "bev_w": 48, "topk": 128},
}
...
def build_afdet_detector3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "afdet_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_afdet_detector3d(in_channels=3, num_classes=3, variant="afdet_tiny")
