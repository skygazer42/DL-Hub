...
_VARIANTS: dict[str, dict[str, object]] = {
    "threedetr_tiny": {"d_model": 64, "queries": 32},
    "threedetr_small": {"d_model": 96, "queries": 48},
    "threedetr_base": {"d_model": 128, "queries": 64},
}


class ThreeDETR(nn.Module):
...
def build_threedetr_detector3d(
    in_channels: int,
    num_classes: int,
    *,
    variant: str = "threedetr_small",
...
if __name__ == "__main__":
    torch.manual_seed(0)
    m = build_threedetr_detector3d(in_channels=3, num_classes=5, variant="threedetr_tiny")
