...
class FedPriorStrategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedprior_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedprior_small": {"hidden": 12, "step_scale": 0.12},
    "fedprior_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedprior_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedprior_tiny",
...
if __name__ == "__main__":
    smoke_test_strategy(build_fedprior_strategy, "fedprior_tiny")
