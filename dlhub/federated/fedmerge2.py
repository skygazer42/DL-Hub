...
class FedMerge2Strategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedmerge2_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedmerge2_small": {"hidden": 12, "step_scale": 0.12},
    "fedmerge2_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedmerge2_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedmerge2_tiny",
