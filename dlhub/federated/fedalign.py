...
class FedAlignStrategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedalign_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedalign_small": {"hidden": 12, "step_scale": 0.12},
    "fedalign_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedalign_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedalign_tiny",
