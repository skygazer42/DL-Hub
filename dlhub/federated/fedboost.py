...
class FedBoostStrategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedboost_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedboost_small": {"hidden": 12, "step_scale": 0.12},
    "fedboost_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedboost_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedboost_tiny",
