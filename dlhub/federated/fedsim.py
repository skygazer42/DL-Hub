...
class FedSimStrategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedsim_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedsim_small": {"hidden": 12, "step_scale": 0.12},
    "fedsim_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedsim_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedsim_tiny",
