...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedcluster_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedcluster_small": {"hidden": 12, "step_scale": 0.12},
    "fedcluster_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedcluster_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedcluster_tiny",
