...
class FedNova2Strategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fednova2_tiny": {"hidden": 8, "step_scale": 0.08},
    "fednova2_small": {"hidden": 12, "step_scale": 0.12},
    "fednova2_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fednova2_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fednova2_tiny",
