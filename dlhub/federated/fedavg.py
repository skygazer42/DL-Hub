...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedavg_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedavg_small": {"hidden": 12, "step_scale": 0.12},
    "fedavg_base": {"hidden": 16, "step_scale": 0.16},
}
...
if __name__ == "__main__":
    smoke_test_strategy(build_fedavg_strategy, "fedavg_tiny")
