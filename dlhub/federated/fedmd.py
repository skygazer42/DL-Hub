...
class FedMdStrategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedmd_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedmd_small": {"hidden": 12, "step_scale": 0.12},
    "fedmd_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedmd_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedmd_tiny",
