...
class FedAlaStrategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedala_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedala_small": {"hidden": 12, "step_scale": 0.12},
    "fedala_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedala_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedala_tiny",
...
if __name__ == "__main__":
    smoke_test_strategy(build_fedala_strategy, "fedala_tiny")
