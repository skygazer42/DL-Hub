...
class FedProx2Strategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedprox2_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedprox2_small": {"hidden": 12, "step_scale": 0.12},
    "fedprox2_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedprox2_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedprox2_tiny",
...
if __name__ == "__main__":
    smoke_test_strategy(build_fedprox2_strategy, "fedprox2_tiny")
