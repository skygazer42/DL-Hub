...
class FedCohortStrategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedcohort_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedcohort_small": {"hidden": 12, "step_scale": 0.12},
    "fedcohort_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedcohort_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedcohort_tiny",
