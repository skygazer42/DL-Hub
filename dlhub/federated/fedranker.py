...
class FedRankerStrategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedranker_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedranker_small": {"hidden": 12, "step_scale": 0.12},
    "fedranker_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedranker_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedranker_tiny",
