...
class FedSparseStrategy(FederatedStrategy):
...
_VARIANTS: dict[str, dict[str, float | int]] = {
    "fedsparse_tiny": {"hidden": 8, "step_scale": 0.08},
    "fedsparse_small": {"hidden": 12, "step_scale": 0.12},
    "fedsparse_base": {"hidden": 16, "step_scale": 0.16},
}


def build_fedsparse_strategy(
    *,
    param_dim: int,
    num_clients: int,
    local_steps: int,
    variant: str = "fedsparse_tiny",
